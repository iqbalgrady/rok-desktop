...
const ANTIGRAVITY_GOOGLE_CLIENT_ID =
  process.env.ROK_DESKTOP_GOOGLE_CLIENT_ID || '';
const ANTIGRAVITY_GOOGLE_CLIENT_SECRET = process.env.ROK_DESKTOP_GOOGLE_CLIENT_SECRET || '';
const GEMINI_GOOGLE_CLIENT_ID =
  process.env.ROK_DESKTOP_GEMINI_CLIENT_ID || '';
const GEMINI_GOOGLE_CLIENT_SECRET = process.env.ROK_DESKTOP_GEMINI_CLIENT_SECRET || '';
