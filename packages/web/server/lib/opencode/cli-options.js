export const parseServeCliOptions = ({
  ...
  const envTunnelConfig = typeof envTunnelConfigRaw === 'string'
    ...
    : undefined;
  const envTunnelToken = env.ROK_DESKTOP_TUNNEL_TOKEN || undefined;
  const envTunnelHostname = env.ROK_DESKTOP_TUNNEL_HOSTNAME || undefined;
  const envApiOnly = env.ROK_DESKTOP_API_ONLY === '1' || env.ROK_DESKTOP_API_ONLY === 'true';
