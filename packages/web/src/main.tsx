...
import { getStoredMobileLayoutPreference } from '@rok-desktop/ui/lib/mobileLayoutPreference';
import type { HostedSurface } from '@rok-desktop/ui/lib/runtimeSurface';
...
declare global {
  interface Window {
    ...
    __ROK_DESKTOP_SURFACE__?: HostedSurface;
  }
}
...
window.__ROK_DESKTOP_SURFACE__ = hostedSurface;
...
if (hostedSurface === 'mobile') {
  void import('@rok-desktop/ui/apps/renderMobileApp')
    .then(({ renderMobileApp }) => {
      renderMobileApp(window.__ROK_DESKTOP_RUNTIME_APIS__ ?? createConfiguredWebAPIs());
    });
} else {
  void import('@rok-desktop/ui/main');
}
