import type { ApnsTokenPayload, PushAPI, PushSubscribePayload, PushUnsubscribePayload } from '@rok-desktop/ui/lib/api/types';
import { runtimeFetch } from '@rok-desktop/ui/lib/runtime-fetch';
