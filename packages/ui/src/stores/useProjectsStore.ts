...
const getLocalRuntimeOrigin = (): string => {
  ...
  const value = (window as typeof window & { __ROK_DESKTOP_LOCAL_ORIGIN__?: string }).__ROK_DESKTOP_LOCAL_ORIGIN__;
...
const createVSCodeWorkspaceProjects = (
  ...
  if (streamDebugEnabled()) {
    console.log('[Rok Desktop][VSCode][projects] Using workspace projects', projects);
  }
...
if (typeof window !== 'undefined') {
  window.addEventListener('rok-desktop:settings-synced', (event: Event) => {
