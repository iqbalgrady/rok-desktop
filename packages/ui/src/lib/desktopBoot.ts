 ...
 * it as `window.__ROK_DESKTOP_DESKTOP_BOOT_OUTCOME__`. This module provides
...
export function getInjectedBootOutcome(): DesktopBootOutcome | null {
  ...
  const raw = (window as { __ROK_DESKTOP_DESKTOP_BOOT_OUTCOME__?: unknown })
    .__ROK_DESKTOP_DESKTOP_BOOT_OUTCOME__;
