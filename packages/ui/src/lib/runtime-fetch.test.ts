...
import { createOpencodeClient } from '@/lib/rokcode/types';
  ...
  test('rewrites current-origin absolute API URLs only', () => {
    ...
    try {
      ...
      Object.defineProperty(globalThis, 'window', {
        configurable: true,
        value: { location: { origin: 'rok-desktop-ui://app', href: 'rok-desktop-ui://app/index.html' } },
      });

      expect(buildRuntimeFetchUrl('rok-desktop-ui://app/api/config/settings')).toBe('https://api.example/api/config/settings');
