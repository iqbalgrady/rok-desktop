...
export const dict: Record<I18nKey, string> = {
  ...
  'aboutDialog.diagnosticsDescription': 'Rok Desktop 상태, OpenCode 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Rok Desktop가 OpenCode를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'OpenCode는 Rok Desktop의 심장입니다. 먼저 설치하고 시작하세요.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Rok Desktop 설정에 저장하고 OpenCode 구성을 다시 로드합니다.',
  ...
  'rokcodeUpdate.toast.actions.reload': 'OpenCode 다시 로드',
  ...
  'rokcodeUpdate.toast.failed.title': 'OpenCode를 업데이트할 수 없음',
  'rokcodeUpdate.toast.failed.description': 'OpenCode 업그레이드에 실패했습니다.',
  'rokcodeUpdate.toast.reload.message': 'OpenCode 다시 시작 중...',
