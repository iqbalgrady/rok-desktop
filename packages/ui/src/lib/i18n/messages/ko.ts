...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '더 빠르게 접근하려면 Rok Desktop를 설치하세요',
  'pwa.installPrompt.action': '설치',
  'pwa.installPrompt.dismiss': '닫기',
  'pwa.installPrompt.started': '설치가 시작되었습니다',
  'pwa.installPrompt.installed': 'Rok Desktop가 설치되었습니다',
  ...
  'mobile.connect.welcome.title': 'Rok Desktop에 연결',
  ...
  'mobile.connect.password.placeholder': 'Rok Desktop 비밀번호',
  ...
  'mobile.connect.scan.invalid': '이 QR 코드는 Rok Desktop 연결 코드가 아닙니다.',
  ...
  'mobile.connect.error.unreachable': '해당 Rok Desktop 서버에 연결할 수 없습니다.',
  ...
  'sessions.sidebar.footer.actions.aboutRok Desktop': 'Rok Desktop 정보',
  ...
  'contextPanel.browser.trustNotice': '여기서 여는 페이지는 Rok Desktop에 대한 전체 액세스 권한으로 실행됩니다 — 검사와 스크린샷에 필요합니다. 신뢰하는 사이트만 여세요: 악성 페이지가 데이터를 읽거나 사용자를 대신해 동작할 수 있습니다.',
  ...
  'header.services.shutdownDev': 'Rok Desktop 종료',
  ...
  'aboutDialog.openChamberVersionLabel': 'Rok Desktop 버전 {version}',
  'aboutDialog.openCodeVersionLabel': 'Rokcode 버전 {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Rok Desktop 상태, Rokcode 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'helpDialog.description': '이 단축키로 Rok Desktop를 빠르게 탐색하세요',
  ...
  'header.actions.openAppMenu': 'Rok Desktop 메뉴',
  'header.actions.openAppMenuAria': 'Rok Desktop 메뉴 열기',
  ...
  'chat.emptyState.rokcodeUnreachable': 'Rokcode에 연결할 수 없음',
  ...
  'openCodeStatusDialog.title': 'Rokcode 상태',
  'openCodeStatusDialog.description': '현재 Rokcode 상태와 진단 정보를 확인합니다.',
  ...
  'sessionAuth.locked.unlockTitle': 'Rok Desktop 잠금 해제',
  ...
  'desktopHostSwitcher.description': '로컬과 원격 Rok Desktop 서버 간에 전환합니다',
  ...
  'multiRun.window.description': 'Rok Desktop 멀티런 창.',
  ...
  'onboarding.chooser.title': 'Rok Desktop에 오신 것을 환영합니다',
  ...
  'onboarding.localSetup.title': 'Rokcode 설정',
  'onboarding.localSetup.description': '계속하려면 Rokcode CLI를 설치하세요.',
  'onboarding.localSetup.dialog.selectRokcodeBinary': 'rokcode 바이너리 선택',
  'onboarding.localSetup.errors.cliNotReady': 'Rokcode CLI가 아직 준비되지 않았습니다. 설치가 완료되었는지 확인하고 다시 시도하세요.',
  'onboarding.localSetup.errors.detectionFailed': '감지에 실패했습니다',
  'onboarding.localSetup.windows.title': 'Windows 설정',
  'onboarding.localSetup.windows.stepInstallWsl': '아래 명령으로 Rokcode를 설치하세요.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Rok Desktop가 Rokcode를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'Rokcode는 Rok Desktop의 심장입니다. 먼저 설치하고 시작하세요.',
  'onboarding.localSetup.docs.windows': 'Rokcode 문서',
  'onboarding.localSetup.docs.default': 'Rokcode 문서',
  ...
  'onboarding.localSetup.helper.checkAndContinue': 'Rokcode CLI를 사용할 수 있으면 확인을 누르세요. 성공하면 자동으로 메인 화면으로 이동합니다.',
  'onboarding.localSetup.status.watching': 'Rokcode 대기 중',
  'onboarding.localSetup.status.autoContinue': '감지되면 자동으로 계속됩니다.',
  'onboarding.localSetup.field.alreadyInstalled': '이미 설치되어 있나요? Rokcode CLI 경로 설정:',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Rok Desktop 설정에 저장하고 Rokcode 구성을 다시 로드합니다.',
  'onboarding.localSetup.remotePreference': '원격 서버를 사용하시겠어요?',
  'onboarding.localSetup.actions.connectRemoteServer': '리모트 서버 연결 →',
  'onboarding.localSetup.windows.hintInstallInWsl': 'Windows에서는 Rokcode를 네이티브로 설치하고 실행하세요.',
  'onboarding.localSetup.windows.hintDetectionFailed': '감지에 실패하면 rokcode.cmd 또는 rokcode.exe 같은 네이티브 경로를 설정하세요.',
  'onboarding.localSetup.hint.ensurePath': '이미 설치되어 있나요? rokcode가 PATH에 있는지 확인하세요.',
  'onboarding.localSetup.hint.setEnv': '또는 `ROKCODE_BINARY` 환경 변수를 설정하세요.',
  ...
  'onboarding.remoteConnection.description': '연결할 Rok Desktop 서버 주소를 입력하세요.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'URL이 Rok Desktop 서버를 가리키는지 확인하거나 서버 관리자에게 문의하세요.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '이 인스턴스는 다른 Rok Desktop 버전을 실행 중입니다. 연결할 수 있지만 문제가 있으면 양쪽 앱을 업데이트하세요.',
  'onboarding.remoteConnection.probe.incompatibleMessage': '서버에서 Rok Desktop가 실행 중이지만 이 앱 버전과 호환되지 않습니다. 서버의 Rok Desktop를 업데이트한 후 다시 시도하세요.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '서버가 응답했지만 Rok Desktop가 실행 중이 아닙니다. 주소가 Rok Desktop 서버를 가리키는지 확인하세요.',
  'onboarding.remoteConnection.probe.unreachableMessage': '서버에 연결할 수 없습니다. 네트워크 연결과 서버 주소를 확인하세요.',
  'onboarding.desktopRecovery.localUnavailable.title': '로컬 Rokcode를 사용할 수 없음',
  'onboarding.desktopRecovery.localUnavailable.description': 'Rokcode CLI를 시작할 수 없거나 설치되어 있지 않습니다. Rokcode를 설치하거나 원격 서버에 연결하세요.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '"{host}"의 서버에서 Rok Desktop가 실행 중이 아닙니다. 주소가 Rok Desktop 서버를 가리키는지 확인하세요.',
  'onboarding.desktopRecovery.remoteIncompatible.title': '서버 업데이트 필요',
  'onboarding.desktopRecovery.remoteIncompatible.description': '"{host}"의 Rok Desktop 서버가 이 앱 버전과 호환되지 않습니다. 서버의 Rok Desktop를 업데이트한 후 다시 시도하세요.',
  ...
  'startup.initRecovery.description': 'Rok Desktop 초기화를 완료할 수 없습니다. 서버가 실행 중인지 확인한 뒤 다시 시도하세요.',
  ...
  'updateDialog.header.updating': 'Rok Desktop 업데이트 중…',
  ...
  'updateDialog.error.takingLonger': '업데이트가 예상보다 오래 걸립니다. 잠시 기다린 뒤 새로고침하거나 `rok-desktop update`를 실행하세요.',
  'rokcodeUpdate.toast.available.title': 'Rokcode 업데이트',
  'rokcodeUpdate.toast.available.description': '버전 {version} 사용 가능.',
  'rokcodeUpdate.toast.actions.update': '업데이트',
  'rokcodeUpdate.toast.actions.dismiss': '닫기',
  'rokcodeUpdate.toast.actions.reload': 'Rokcode 다시 로드',
  'rokcodeUpdate.toast.upgrading.title': 'Rokcode 업데이트 중...',
  'rokcodeUpdate.toast.upgrading.description': 'Rok Desktop를 열어 두세요.',
  'rokcodeUpdate.toast.updated.title': 'Rokcode 업데이트 완료',
  'rokcodeUpdate.toast.updated.description': '업데이트가 설치되었습니다.',
  'rokcodeUpdate.toast.updated.descriptionWithVersion': '버전 {version}이 설치되었습니다.',
  'rokcodeUpdate.toast.failed.title': 'Rokcode를 업데이트할 수 없음',
  'rokcodeUpdate.toast.failed.description': 'Rokcode 업그레이드에 실패했습니다.',
  'rokcodeUpdate.toast.reload.message': 'Rokcode 다시 시작 중...',
  ...
  'openChamberLogo.aria.logo': 'Rok Desktop 로고',
