...
export const dict: Record<I18nKey, string> = {
  ...
  'aboutDialog.diagnosticsDescription': '包含 Rok Desktop 狀態、OpenCode 健康資訊、目錄和專案。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 Rok Desktop 未自動偵測到 OpenCode，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'OpenCode 是 Rok Desktop 的核心，先安裝它即可開始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 Rok Desktop 設定並重新載入 OpenCode 設定。',
  ...
  'rokcodeUpdate.toast.available.title': 'OpenCode 更新',
  ...
  'rokcodeUpdate.toast.actions.reload': '重新載入 OpenCode',
  'rokcodeUpdate.toast.upgrading.title': '正在更新 OpenCode...',
  ...
  'rokcodeUpdate.toast.failed.title': '無法更新 OpenCode',
  'rokcodeUpdate.toast.failed.description': 'OpenCode 升級失敗。',
  'rokcodeUpdate.toast.reload.message': '正在重新啟動 OpenCode...',
