...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安裝 Rok Desktop 以便更快存取',
  'pwa.installPrompt.action': '安裝',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已開始安裝',
  'pwa.installPrompt.installed': 'Rok Desktop 已安裝',
  ...
  'mobile.connect.welcome.title': '連線至 Rok Desktop',
  ...
  'mobile.connect.password.placeholder': 'Rok Desktop 密碼',
  ...
  'mobile.connect.scan.invalid': '此 QR code 不是 Rok Desktop 連線代碼。',
  ...
  'mobile.connect.error.unreachable': '無法連線至該 Rok Desktop 伺服器。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此實例正在執行不同版本的 Rok Desktop。你可以連線；如果功能異常，請更新兩端應用程式。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '伺服器正在執行 Rok Desktop，但與此應用程式版本不相容。請更新伺服器上的 Rok Desktop 後重試。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新伺服器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」上的 Rok Desktop 伺服器與此應用程式版本不相容。請更新伺服器上的 Rok Desktop 後重試。',
  ...
  'sessions.sidebar.footer.actions.aboutRok Desktop': '關於 Rok Desktop',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 Rok Desktop 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'header.services.shutdownDev': '停止 Rok Desktop',
  ...
  'aboutDialog.openChamberVersionLabel': 'Rok Desktop 版本 {version}',
  'aboutDialog.openCodeVersionLabel': 'Rokcode 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 Rok Desktop 狀態、Rokcode 健康資訊、目錄和專案。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 Rok Desktop',
  ...
  'header.actions.openAppMenu': 'Rok Desktop 選單',
  'header.actions.openAppMenuAria': '開啟 Rok Desktop 選單',
  ...
  'chat.emptyState.rokcodeUnreachable': '無法連線 Rokcode',
  ...
  'openCodeStatusDialog.title': 'Rokcode 狀態',
  'openCodeStatusDialog.description': '查看目前 Rokcode 狀態與診斷資訊。',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 Rok Desktop',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 Rok Desktop 伺服器之間切換',
  ...
  'multiRun.window.description': 'Rok Desktop 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 Rok Desktop',
  ...
  'onboarding.localSetup.title': '設定 Rokcode',
  'onboarding.localSetup.description': '安裝 Rokcode CLI 以繼續。',
  'onboarding.localSetup.dialog.selectRokcodeBinary': '選擇 Rokcode 執行檔',
  'onboarding.localSetup.errors.cliNotReady': 'Rokcode CLI 尚未就緒。請確認安裝完成後重試。',
  'onboarding.localSetup.errors.detectionFailed': '偵測失敗',
  'onboarding.localSetup.windows.title': 'Windows 設定',
  'onboarding.localSetup.windows.stepInstallWsl': '使用下方命令安裝 Rokcode。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 Rok Desktop 未自動偵測到 Rokcode，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'Rokcode 是 Rok Desktop 的核心，先安裝它即可開始。',
  'onboarding.localSetup.docs.windows': 'Rokcode 文件',
  'onboarding.localSetup.docs.default': 'Rokcode 文件',
  ...
  'onboarding.localSetup.helper.checkAndContinue': '點擊偵測 Rokcode CLI 是否可用。成功後將自動進入主介面。',
  'onboarding.localSetup.status.watching': '正在等待 Rokcode',
  'onboarding.localSetup.status.autoContinue': '偵測到後將自動繼續。',
  'onboarding.localSetup.field.alreadyInstalled': '已安裝？設定 Rokcode CLI 路徑：',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 Rok Desktop 設定並重新載入 Rokcode 設定。',
  'onboarding.localSetup.remotePreference': '更希望使用遠端伺服器？',
  'onboarding.localSetup.actions.connectRemoteServer': '連接遠端伺服器 →',
  'onboarding.localSetup.windows.hintInstallInWsl': '在 Windows 上，請原生安裝並執行 Rokcode。',
  'onboarding.localSetup.windows.hintDetectionFailed': '若偵測失敗，請設定原生路徑，例如 rokcode.cmd 或 rokcode.exe。',
  'onboarding.localSetup.hint.ensurePath': '已安裝？請確認 rokcode 在你的 PATH 中。',
  'onboarding.localSetup.hint.setEnv': '或設定 ROKCODE_BINARY 環境變數。',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 Rok Desktop 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 Rok Desktop 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 Rok Desktop。請確認位址是否指向 Rok Desktop 伺服器。',
  'onboarding.remoteConnection.probe.unreachableMessage': '伺服器無法連線。請檢查網路連線並確認伺服器位址。',
  'onboarding.desktopRecovery.localUnavailable.title': '本地 Rokcode 無法使用',
  'onboarding.desktopRecovery.localUnavailable.description': 'Rokcode CLI 無法啟動或未安裝。請安裝 Rokcode，或改為連接遠端伺服器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 Rok Desktop。請確認位址是否指向 Rok Desktop 伺服器。',
  ...
  'startup.initRecovery.description': 'Rok Desktop 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'updateDialog.header.updating': '正在更新 Rok Desktop...',
  ...
  'updateDialog.error.takingLonger': '更新耗時超出預期。請稍等後重新整理，或執行：rok-desktop update',
  'rokcodeUpdate.toast.available.title': 'Rokcode 更新',
  'rokcodeUpdate.toast.available.description': '版本 {version} 可安裝。',
  'rokcodeUpdate.toast.actions.update': '更新',
  'rokcodeUpdate.toast.actions.dismiss': '忽略',
  'rokcodeUpdate.toast.actions.reload': '重新載入 Rokcode',
  'rokcodeUpdate.toast.upgrading.title': '正在更新 Rokcode...',
  'rokcodeUpdate.toast.upgrading.description': '請保持 Rok Desktop 開啟。',
  'rokcodeUpdate.toast.updated.title': 'Rokcode 已更新',
  'rokcodeUpdate.toast.updated.description': '更新已安裝。',
  'rokcodeUpdate.toast.updated.descriptionWithVersion': '版本 {version} 已安裝。',
  'rokcodeUpdate.toast.failed.title': '無法更新 Rokcode',
  'rokcodeUpdate.toast.failed.description': 'Rokcode 升級失敗。',
  'rokcodeUpdate.toast.reload.message': '正在重新啟動 Rokcode...',
  ...
  'openChamberLogo.aria.logo': 'Rok Desktop 標誌',
