export const settingsDict = {
  ...
  'settings.rok-desktop.about.field.openCodeVersion': 'OpenCode version',
  ...
  'settings.rok-desktop.opencodeCli.field.binaryPath': 'OpenCode Binary Path',
  ...
  'settings.rok-desktop.opencodeCli.actions.restartingOpenCode': 'Restarting OpenCode…',
  'settings.rok-desktop.opencodeCli.dialog.selectBinaryTitle': 'Select opencode binary',
  ...
  'settings.rok-desktop.worktrees.list.tooltip': 'Worktrees live outside the repo (OpenCode-managed). Deleting a worktree also removes linked sessions.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by Rok Desktop.',
  ...
  'settings.rok-desktop.defaults.summaryOpenCodeDefault': 'OpenCode agent default',
