export const settingsDict = {
  ...
  'settings.window.description': 'Rok Desktop settings window.',
  ...
  'settings.view.actions.reloadOpenCode': 'Reload Rokcode',
  'settings.view.actions.reloadOpenCodeTooltip': 'Restart Rokcode and reload its configuration.',
  ...
  'settings.snippets.page.hint': 'Use #name in prompts. Supports aliases and prepend/append blocks compatible with rokcode-snippets.',
  ...
  'settings.rok-desktop.tunnel.title': 'Remote Tunnel',
  'settings.rok-desktop.tunnel.description': 'Configure secure remote access with quick links or your own managed remote Cloudflare tunnel.',
  'settings.rok-desktop.tunnel.note.serverSideEnforced': 'Secure tunnel access is enforced server-side.',
  'settings.rok-desktop.tunnel.note.connectLinksOneTime': 'Connect links are one-time and are revoked when tunnel stops or connect-link TTL expires.',
  'settings.rok-desktop.tunnel.note.cloudflareConnectorTarget': 'Cloudflare connector target:',
  'settings.rok-desktop.tunnel.note.cloudflareConnectorTargetUse': 'For Cloudflare connector target, use',
  'settings.rok-desktop.tunnel.note.tokensSavedPerTunnel': 'Tokens are saved per tunnel and reused from disk.',
  'settings.rok-desktop.tunnel.note.customConfigUsed': 'Custom config file will be used when starting the tunnel.',
  'settings.rok-desktop.tunnel.note.defaultConfigUsed': 'When empty, cloudflared uses its default config (~/.cloudflared/config.yml).',
  'settings.rok-desktop.tunnel.note.managedRemoteRequiresDomain': 'Managed remote tunnels require a purchased domain in your Cloudflare account.',
  'settings.rok-desktop.tunnel.note.managedLocalUsesConfig': 'Managed local tunnels use your local cloudflared configuration file.',
  'settings.rok-desktop.tunnel.note.startModeAndGenerateLink': 'Start a {mode} tunnel and generate a one-time connect link. Do not close the app while this tunnel is in use.',
  'settings.rok-desktop.tunnel.note.scanQrToConnect': 'Scan with your phone to connect.',
  'settings.rok-desktop.tunnel.section.redeemedAccessLinks': 'Redeemed access links',
  'settings.rok-desktop.tunnel.section.savedManagedRemoteTunnels': 'Saved managed remote tunnels',
  'settings.rok-desktop.tunnel.notAvailable.cloudflaredNotFound': 'cloudflared not found',
  'settings.rok-desktop.tunnel.notAvailable.dependencyNotFound': '{dependency} was not found.',
  'settings.rok-desktop.tunnel.notAvailable.installHint': 'Install it to enable remote tunnel access:',
  'settings.rok-desktop.tunnel.field.provider': 'Provider',
  'settings.rok-desktop.tunnel.field.providerPlaceholder': 'Select provider',
  'settings.rok-desktop.tunnel.field.tunnelType': 'Tunnel type',
  'settings.rok-desktop.tunnel.field.connectLinkTtl': 'Connect link TTL',
  'settings.rok-desktop.tunnel.field.tunnelSessionTtl': 'Tunnel session TTL',
  'settings.rok-desktop.tunnel.field.hostnameLabel': 'Hostname:',
  'settings.rok-desktop.tunnel.field.savedTokenAvailablePlaceholder': 'Saved token available (optional to replace)',
  'settings.rok-desktop.tunnel.field.pasteTokenPlaceholder': 'Paste token for this tunnel',
  'settings.rok-desktop.tunnel.field.newPresetNamePlaceholder': 'Tunnel name (e.g. Production)',
  'settings.rok-desktop.tunnel.field.newPresetHostnamePlaceholder': 'Hostname (e.g. oc.example.com)',
  'settings.rok-desktop.tunnel.field.newPresetTokenPlaceholder': 'Token',
  'settings.rok-desktop.tunnel.field.managedRemoteTokenInfoAria': 'Managed remote tunnel token info',
  'settings.rok-desktop.tunnel.field.configurationFile': 'Configuration file',
  'settings.rok-desktop.tunnel.field.configurationFilePlaceholder': 'Using default cloudflared config',
  'settings.rok-desktop.tunnel.field.managedRemoteTunnelToConnect': 'Managed remote tunnel to connect',
  'settings.rok-desktop.tunnel.field.selectSavedTunnelPlaceholder': 'Select saved tunnel',
  'settings.rok-desktop.tunnel.field.publicUrlHint': 'Public URL (not accessible without a token)',
  'settings.rok-desktop.tunnel.field.connectLink': 'Connect link',
  'settings.rok-desktop.tunnel.field.expires': 'Expires',
  'settings.rok-desktop.tunnel.field.connectQrAlt': 'Tunnel connect QR code',
  'settings.rok-desktop.tunnel.actions.removePresetAria': 'Remove {name}',
  'settings.rok-desktop.tunnel.actions.saveToken': 'Save token',
  'settings.rok-desktop.tunnel.actions.browseConfigFileAria': 'Browse config file',
  'settings.rok-desktop.tunnel.actions.clearConfigFileAria': 'Clear config file',
  'settings.rok-desktop.tunnel.actions.openManagedRemoteDocs': 'Check documentation on how to configure a managed remote tunnel',
  'settings.rok-desktop.tunnel.actions.openManagedLocalDocs': 'Check documentation on managed local tunnel configuration',
  'settings.rok-desktop.tunnel.actions.startTunnel': 'Start Tunnel',
  'settings.rok-desktop.tunnel.actions.startingTunnel': 'Starting tunnel...',
  'settings.rok-desktop.tunnel.actions.stopTunnel': 'Stop Tunnel',
  'settings.rok-desktop.tunnel.actions.stopping': 'Stopping...',
  'settings.rok-desktop.tunnel.actions.newConnectLink': 'New connect link',
  'settings.rok-desktop.tunnel.actions.copied': 'Copied',
  'settings.rok-desktop.tunnel.actions.retry': 'Retry',
  'settings.rok-desktop.tunnel.option.moreProvidersSoon': 'More providers coming soon',
  'settings.rok-desktop.tunnel.option.mode.quick.label': 'Quick',
  'settings.rok-desktop.tunnel.option.mode.quick.tooltip': 'Quick Tunnel is best effort and uptime is not guaranteed.',
  'settings.rok-desktop.tunnel.option.mode.managedRemote.label': 'Managed Remote',
  'settings.rok-desktop.tunnel.option.mode.managedRemote.tooltip': 'Managed Remote uses your Cloudflare account and hostname for long-lived access.',
  'settings.rok-desktop.tunnel.option.mode.managedLocal.label': 'Managed Local',
  'settings.rok-desktop.tunnel.option.mode.managedLocal.tooltip': 'Managed Local uses your local cloudflared configuration file.',
  'settings.rok-desktop.tunnel.warning.quickModeReliability': 'For more reliable long-lived access, switch to Managed Remote or Managed Local tunnel mode.',
  'settings.rok-desktop.tunnel.warning.replacesActiveTunnel': 'Starting this tunnel replaces the active tunnel and revokes existing connect links and remote sessions.',
  ...
  'settings.rok-desktop.tunnel.state.loading': 'Loading',
  'settings.rok-desktop.tunnel.state.expired': 'Expired',
  'settings.rok-desktop.tunnel.state.revoked': 'Revoked',
  'settings.rok-desktop.tunnel.state.inactive': 'Inactive',
  'settings.rok-desktop.tunnel.state.noExpiry': 'No expiry',
  'settings.rok-desktop.tunnel.state.never': 'Never',
  'settings.rok-desktop.tunnel.state.tunnelReady': 'Tunnel ready',
  'settings.rok-desktop.tunnel.session.redeemedAt': 'Redeemed {time}',
  'settings.rok-desktop.tunnel.session.expiresIn': 'Expires in {remaining}',
  'settings.rok-desktop.tunnel.session.inactiveWithReason': 'Inactive ({reason})',
  'settings.rok-desktop.tunnel.error.invalidConfigExtension': 'Config file must use .yml, .yaml, or .json extension.',
  'settings.rok-desktop.tunnel.tooltip.tokensSavedPath': 'Tokens are saved in ~/.config/rok-desktop/cloudflare-managed-remote-tunnels.json.',
  'settings.rok-desktop.tunnel.empty.noManagedRemoteTunnels': 'No managed remote tunnels saved yet.',
  'settings.rok-desktop.tunnel.toast.checkAvailabilityFailed': 'Failed to check tunnel availability',
  'settings.rok-desktop.tunnel.toast.saveSettingsFailed': 'Failed to save tunnel settings',
  'settings.rok-desktop.tunnel.toast.saveTtlFailed': 'Failed to save tunnel TTL settings',
  'settings.rok-desktop.tunnel.toast.saveTokenFailed': 'Failed to save managed remote tunnel token',
  'settings.rok-desktop.tunnel.toast.selectOrAddManagedRemoteFirst': 'Select or add a managed remote tunnel first',
  'settings.rok-desktop.tunnel.toast.managedRemoteTokenRequiredBeforeStarting': 'Managed remote tunnel token is required before starting',
  'settings.rok-desktop.tunnel.toast.addManagedRemoteTokenBeforeStarting': 'Add a managed remote tunnel token before starting',
  'settings.rok-desktop.tunnel.toast.startFailed': 'Failed to start tunnel',
  'settings.rok-desktop.tunnel.toast.startedButNoPublicUrl': 'Tunnel started but no public URL was returned',
  'settings.rok-desktop.tunnel.toast.replacedTunnelSingleSingle': 'Replaced previous tunnel: revoked 1 link, invalidated 1 session.',
  'settings.rok-desktop.tunnel.toast.replacedTunnelSingleManySessions': 'Replaced previous tunnel: revoked 1 link, invalidated {invalidatedSessionCount} sessions.',
  'settings.rok-desktop.tunnel.toast.replacedTunnelManyLinksSingleSession': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated 1 session.',
  'settings.rok-desktop.tunnel.toast.replacedTunnelManyMany': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated {invalidatedSessionCount} sessions.',
  'settings.rok-desktop.tunnel.toast.linkReady': 'Tunnel link ready',
  'settings.rok-desktop.tunnel.toast.stopped': 'Tunnel stopped',
  'settings.rok-desktop.tunnel.toast.stopFailed': 'Failed to stop tunnel',
  'settings.rok-desktop.tunnel.toast.connectLinkCopied': 'Connect link copied',
  'settings.rok-desktop.tunnel.toast.copyUrlFailed': 'Failed to copy URL',
  'settings.rok-desktop.tunnel.toast.saveSelectedManagedRemoteFailed': 'Failed to save selected managed remote tunnel',
  'settings.rok-desktop.tunnel.toast.tunnelNameRequired': 'Tunnel name is required',
  'settings.rok-desktop.tunnel.toast.managedRemoteHostnameRequired': 'Managed remote tunnel hostname is required',
  'settings.rok-desktop.tunnel.toast.managedRemoteTokenRequired': 'Managed remote tunnel token is required',
  'settings.rok-desktop.tunnel.toast.hostnameAlreadyExists': 'This hostname already exists',
  'settings.rok-desktop.tunnel.toast.managedRemoteSaved': 'Managed remote tunnel saved',
  'settings.rok-desktop.tunnel.toast.managedRemoteRemoved': 'Managed remote tunnel removed',
  ...
  'settings.remoteInstances.direct.title': 'Other Rok Desktop servers',
  'settings.remoteInstances.direct.description': 'Add another Rok Desktop server by URL. Use this when the server is already running and you have a connection token.',
  ...
  'settings.remoteInstances.direct.import.description': 'Paste a connection link from another Rok Desktop server.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Invalid Rok Desktop connection link.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Create a secure link or token so Rok Desktop can connect to this server.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Choose whether Rok Desktop should start the server for you, or connect to one that is already running.',
  ...
  'settings.rok-desktop.about.title': 'About Rok Desktop',
  'settings.rok-desktop.about.field.version': 'Version',
  'settings.rok-desktop.about.field.openCodeVersion': 'Rokcode version',
  'settings.rok-desktop.about.state.checking': 'Checking...',
  'settings.rok-desktop.about.state.upToDate': 'Up to date',
  'settings.rok-desktop.about.state.unknown': 'unknown',
  'settings.rok-desktop.about.actions.checkUpdates': 'Check updates',
  'settings.rok-desktop.about.actions.update': 'Update',
  'settings.rok-desktop.about.actions.updateToVersion': 'Update to {version}',
  'settings.rok-desktop.about.actions.checkForUpdates': 'Check for updates',
  'settings.rok-desktop.about.toast.latestVersion': 'You are on the latest version',
  ...
  'settings.agents.page.toast.savedManualRestart': 'Saved to disk. Restart your connected Rokcode server to apply the changes.',
  ...
  'settings.behavior.page.warning.description': 'Changes made here update {path}. Rokcode also includes any project-level AGENTS.md rules when they exist.',
  ...
  'settings.skills.sidebar.badge.opencode': 'rokcode',
  ...
  'settings.skills.location.option.userOpencode.label': 'User / Rokcode',
  'settings.skills.location.option.userOpencode.description': 'Global Rokcode config location',
  'settings.skills.location.option.projectOpencode.label': 'Project / Rokcode',
  'settings.skills.location.option.projectOpencode.description': 'Current project .rokcode location',
  ...
  'settings.skills.catalog.conflicts.source.opencode': 'rokcode',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. Rok Desktop will scan it for folders containing',
  ...
  'settings.rok-desktop.passkeys.title': 'Passkeys',
  'settings.rok-desktop.passkeys.field.currentDevice': 'Current device',
  'settings.rok-desktop.passkeys.actions.add': 'Add passkey',
  'settings.rok-desktop.passkeys.actions.cancelSetup': 'Cancel passkey setup',
  'settings.rok-desktop.passkeys.actions.signOutEverywhere': 'Sign out everywhere',
  'settings.rok-desktop.passkeys.actions.signingOut': 'Signing out…',
  'settings.rok-desktop.passkeys.actions.removing': 'Removing…',
  'settings.rok-desktop.passkeys.state.uiPasswordRequired': 'Passkeys are available only when the UI password lock is enabled.',
  'settings.rok-desktop.passkeys.state.loading': 'Loading passkeys…',
  'settings.rok-desktop.passkeys.state.noneSaved': 'No passkeys saved for this host yet.',
  'settings.rok-desktop.passkeys.item.lastUsed': 'Last used {time}',
  'settings.rok-desktop.passkeys.item.added': 'Added {time}',
  'settings.rok-desktop.passkeys.time.neverUsed': 'Never used',
  'settings.rok-desktop.passkeys.toast.loadFailed': 'Could not load passkeys.',
  'settings.rok-desktop.passkeys.toast.enableUiPasswordFirst': 'Enable the UI password lock before adding passkeys.',
  'settings.rok-desktop.passkeys.toast.added': 'Passkey added',
  'settings.rok-desktop.passkeys.toast.setupCanceled': 'Passkey setup canceled',
  'settings.rok-desktop.passkeys.toast.addFailed': 'Could not add passkey.',
  'settings.rok-desktop.passkeys.toast.removed': 'Passkey removed',
  'settings.rok-desktop.passkeys.toast.removeFailed': 'Could not remove passkey.',
  'settings.rok-desktop.passkeys.toast.clearAuthFailed': 'Could not clear saved authentication.',
  'settings.rok-desktop.sessionRetention.title': 'Session Retention',
  'settings.rok-desktop.sessionRetention.tooltip': 'Automatically archive or delete inactive sessions based on last activity. Keeps the 5 most recent sessions.',
  'settings.rok-desktop.sessionRetention.field.enableAutoCleanupAria': 'Enable auto-cleanup',
  'settings.rok-desktop.sessionRetention.field.enableAutoCleanup': 'Enable Auto-Cleanup',
  'settings.rok-desktop.sessionRetention.field.retentionPeriod': 'Retention Period',
  'settings.rok-desktop.sessionRetention.field.retentionPeriodAria': 'Retention period in days',
  'settings.rok-desktop.sessionRetention.field.days': 'days',
  'settings.rok-desktop.sessionRetention.field.whenSessionsExpire': 'When sessions expire',
  'settings.rok-desktop.sessionRetention.actions.resetRetentionAria': 'Reset retention period',
  'settings.rok-desktop.sessionRetention.actions.runCleanupNow': 'Run cleanup now',
  'settings.rok-desktop.sessionRetention.actions.cleaningUp': 'Cleaning up...',
  'settings.rok-desktop.sessionRetention.action.archive': 'Archive',
  'settings.rok-desktop.sessionRetention.action.delete': 'Delete',
  'settings.rok-desktop.sessionRetention.manualCleanup.title': 'Manual Cleanup',
  'settings.rok-desktop.sessionRetention.manualCleanup.eligibleArchiveNow': 'Eligible for archiving right now: {count}',
  'settings.rok-desktop.sessionRetention.manualCleanup.eligibleDeleteNow': 'Eligible for deletion right now: {count}',
  'settings.rok-desktop.sessionRetention.toast.noneEligibleArchive': 'No sessions eligible for archiving',
  'settings.rok-desktop.sessionRetention.toast.noneEligibleDelete': 'No sessions eligible for deletion',
  'settings.rok-desktop.sessionRetention.toast.archivedCount': 'Archived {count} session(s)',
  'settings.rok-desktop.sessionRetention.toast.deletedCount': 'Deleted {count} session(s)',
  'settings.rok-desktop.sessionRetention.toast.failedArchiveCount': 'Failed to archive {count} session(s)',
  'settings.rok-desktop.sessionRetention.toast.failedDeleteCount': 'Failed to delete {count} session(s)',
  'settings.rok-desktop.desktopNetwork.title': 'Desktop Network Access',
  'settings.rok-desktop.desktopNetwork.field.launchAtLoginAria': 'Start Rok Desktop at login',
  'settings.rok-desktop.desktopNetwork.field.launchAtLogin': 'Start Rok Desktop when you log in',
  'settings.rok-desktop.desktopNetwork.field.launchAtLoginDescription': 'Starts the app in the background without opening a window. Click the Dock icon to open it.',
  'settings.rok-desktop.desktopNetwork.field.allowLanAccessAria': 'Allow LAN access to desktop sidecar',
  'settings.rok-desktop.desktopNetwork.field.allowLanAccess': 'Let other devices on your local network open this app',
  'settings.rok-desktop.desktopNetwork.field.allowLanAccessDescription': 'Restarts the app so phones, tablets, and other computers on your Wi-Fi can open it.',
  'settings.rok-desktop.desktopNetwork.field.warning': 'Warning: while enabled, the app is reachable by anyone on the same local network.',
  'settings.rok-desktop.desktopNetwork.field.passwordRequiredWarning': 'LAN access requires a Desktop UI Password. Until one is set, the desktop app starts local-only.',
  'settings.rok-desktop.desktopPassword.field.password': 'Desktop UI Password',
  'settings.rok-desktop.desktopPassword.field.passwordPlaceholder': 'No password required',
  'settings.rok-desktop.desktopPassword.field.passwordDescription': 'Rok Desktop asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  'settings.rok-desktop.desktopNetwork.hint.openAfterRestart': 'After restart, open from another device: ',
  'settings.rok-desktop.desktopNetwork.hint.openNow': 'Open from another device: ',
  'settings.rok-desktop.desktopNetwork.actions.saveAndRestart': 'Save + Restart',
  'settings.rok-desktop.desktopNetwork.error.loadFailed': 'Failed to load desktop settings',
  'settings.rok-desktop.desktopNetwork.error.saveFailed': 'Failed to save desktop settings',
  'settings.rok-desktop.desktopNetwork.error.savedRestartFailed': 'Saved, but failed to restart app',
  'settings.rok-desktop.desktopNetwork.error.launchAtLoginUnsupported': 'Launch at login is not supported on this system',
  'settings.rok-desktop.desktopNetwork.error.launchAtLoginSaveFailed': 'Failed to update launch at login setting',
  'settings.rok-desktop.opencodeCli.title': 'Rokcode CLI',
  'settings.rok-desktop.opencodeCli.tooltipPrefix': 'Optional absolute path to the',
  'settings.rok-desktop.opencodeCli.tooltipSuffix': 'binary.',
  'settings.rok-desktop.opencodeCli.field.binaryPath': 'Rokcode Binary Path',
  'settings.rok-desktop.opencodeCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/rokcode',
  'settings.rok-desktop.rokcodeCli.field.showUpdateNotifications': 'Show Rokcode update notifications',
  'settings.rok-desktop.rokcodeCli.field.showUpdateNotificationsAria': 'Show Rokcode update notifications',
  'settings.rok-desktop.opencodeCli.actions.browseAria': 'Browse for Rokcode binary path',
  'settings.rok-desktop.opencodeCli.actions.browse': 'Browse',
  'settings.rok-desktop.opencodeCli.actions.saveAndReload': 'Save + Reload',
  'settings.rok-desktop.opencodeCli.actions.restartingOpenCode': 'Restarting Rokcode…',
  'settings.rok-desktop.opencodeCli.dialog.selectBinaryTitle': 'Select rokcode binary',
  'settings.rok-desktop.opencodeCli.tipPrefix': 'Tip: you can also use',
  'settings.rok-desktop.opencodeCli.tipMiddle': 'env var, but this setting persists in',
  ...
  'settings.plugins.toast.reloadFailed': 'rokcode reload failed — restart required',
  ...
  'settings.rok-desktop.keyboardShortcuts.title': 'Keyboard Shortcuts',
  'settings.rok-desktop.keyboardShortcuts.actions.resetAll': 'Reset All',
  'settings.rok-desktop.keyboardShortcuts.actions.overwrite': 'Overwrite',
  'settings.rok-desktop.keyboardShortcuts.tooltip': 'Capture a new key combo, save it, and bindings will update immediately.',
  'settings.rok-desktop.keyboardShortcuts.overwritePrompt': 'This combo is already used by another shortcut. Overwrite and clear that other mapping?',
  'settings.rok-desktop.keyboardShortcuts.field.pressKeys': 'Press keys...',
  'settings.rok-desktop.keyboardShortcuts.error.captureFirst': 'Capture a shortcut first.',
  'settings.rok-desktop.keyboardShortcuts.warning.riskyBrowserShortcut': 'This shortcut can conflict with browser defaults. It is still saved.',
  'settings.rok-desktop.keyboardShortcuts.action.open_go_to_line.label': 'Go to line (files editor)',
  'settings.rok-desktop.keyboardShortcuts.action.open_command_palette.label': 'Open command palette',
  'settings.rok-desktop.keyboardShortcuts.action.focus_input.label': 'Focus input',
  'settings.rok-desktop.keyboardShortcuts.action.open_settings.label': 'Open settings',
  'settings.rok-desktop.keyboardShortcuts.action.toggle_terminal.label': 'Toggle terminal dock',
  'settings.rok-desktop.keyboardShortcuts.action.toggle_terminal_expanded.label': 'Toggle terminal expanded',
  'settings.rok-desktop.keyboardShortcuts.action.toggle_sidebar.label': 'Toggle sidebar',
  'settings.rok-desktop.keyboardShortcuts.action.toggle_right_sidebar.label': 'Toggle right sidebar',
  'settings.rok-desktop.keyboardShortcuts.action.open_right_sidebar_git.label': 'Open right sidebar Git tab',
  'settings.rok-desktop.keyboardShortcuts.action.open_right_sidebar_files.label': 'Open right sidebar Files tab',
  'settings.rok-desktop.keyboardShortcuts.action.cycle_right_sidebar_tab.label': 'Cycle right sidebar tab',
  'settings.rok-desktop.keyboardShortcuts.action.new_chat.label': 'New session',
  'settings.rok-desktop.keyboardShortcuts.action.new_chat_worktree.label': 'New worktree draft',
  'settings.rok-desktop.keyboardShortcuts.action.new_mini_chat.label': 'New Mini Chat window',
  'settings.rok-desktop.keyboardShortcuts.action.open_help.label': 'Open keyboard shortcuts',
  'settings.rok-desktop.keyboardShortcuts.action.toggle_context_plan.label': 'Toggle plan context panel',
  'settings.rok-desktop.keyboardShortcuts.action.toggle_services_menu.label': 'Toggle services menu',
  'settings.rok-desktop.keyboardShortcuts.action.cycle_services_tab.label': 'Cycle services tab',
  'settings.rok-desktop.keyboardShortcuts.action.cycle_theme.label': 'Cycle theme',
  'settings.rok-desktop.keyboardShortcuts.action.cycle_agent.label': 'Cycle agent',
  'settings.rok-desktop.keyboardShortcuts.action.cycle_favorite_model_forward.label': 'Cycle favorite model forward',
  'settings.rok-desktop.keyboardShortcuts.action.cycle_favorite_model_backward.label': 'Cycle favorite model backward',
  'settings.rok-desktop.keyboardShortcuts.action.open_model_selector.label': 'Open model selector',
  'settings.rok-desktop.keyboardShortcuts.action.expand_input.label': 'Expand input',
  'settings.rok-desktop.keyboardShortcuts.action.open_timeline_dialog.label': 'Open conversation timeline',
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open Rok Desktop there.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'Rok Desktop on the remote machine',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Choose how Rok Desktop should run after SSH connects.',
  'settings.remoteInstances.page.section.mainTunnel': 'Local access',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Choose the local address used to open this remote Rok Desktop server.',
  'settings.remoteInstances.page.section.authentication': 'Authentication',
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote Rok Desktop UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How Rok Desktop should be placed on the remote machine when this app starts it for you.',
  ...
  'settings.remoteInstances.page.phase.installingRokDesktop': 'Installing Rok Desktop',
  'settings.remoteInstances.page.phase.updatingRokDesktop': 'Updating Rok Desktop',
  ...
  'settings.rok-desktop.worktrees.state.selectProject': 'Select a project to manage worktrees.',
  'settings.rok-desktop.worktrees.state.gitOnly': 'Worktree settings are only available for Git repositories.',
  'settings.rok-desktop.worktrees.setup.title': 'Setup commands',
  'settings.rok-desktop.worktrees.setup.tooltipPrefix': 'Run automatically inside the new worktree directory when a worktree is created. Use',
  'settings.rok-desktop.worktrees.setup.tooltipSuffix': 'for the project root.',
  'settings.rok-desktop.worktrees.setup.loading': 'Loading...',
  'settings.rok-desktop.worktrees.setup.commandPlaceholder': 'e.g., bun install',
  'settings.rok-desktop.worktrees.setup.removeCommandAria': 'Remove command',
  'settings.rok-desktop.worktrees.setup.addCommand': 'Add command',
  'settings.rok-desktop.worktrees.setup.waitForCommands': 'Wait for setup commands before creating or sending a session',
  'settings.rok-desktop.worktrees.setup.waitForCommandsAria': 'Wait for Worktree setup commands before creating or sending a session',
  'settings.rok-desktop.worktrees.list.title': 'Existing worktrees',
  'settings.rok-desktop.worktrees.list.tooltip': 'Worktrees live outside the repo (Rokcode-managed). Deleting a worktree also removes linked sessions.',
  'settings.rok-desktop.worktrees.list.loading': 'Loading worktrees...',
  'settings.rok-desktop.worktrees.list.empty': 'No worktrees found for this project',
  'settings.rok-desktop.worktrees.list.detachedHead': 'Detached HEAD',
  'settings.rok-desktop.worktrees.list.deleteWorktreeAria': 'Delete worktree {name}',
  ...
  'settings.providers.sidebar.empty.description': 'Check your Rokcode configuration',
  ...
  'settings.providers.page.empty.checkRokcodeConfiguration': 'Check your Rokcode configuration',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to Rokcode and never stored by Rok Desktop.',
  ...
  'settings.mcp.page.status.description.connected': 'Connected and ready for Rokcode to discover tools and resources.',
  'settings.mcp.page.status.description.failedDefault': 'Rokcode could not reach this MCP server.',
  ...
  'settings.mcp.page.auth.waitingForRokcode': 'Waiting for Rokcode to observe the completed browser authorization flow...',
  ...
  'settings.mcp.page.advanced.oauthHint': 'Leave these fields blank to let Rokcode infer OAuth settings from the MCP server.',
  ...
  'settings.mcp.page.env.plainTextWarning': '⚠ Values are stored as plain text in rokcode.json',
  ...
  'settings.mcp.page.deleteDialog.descriptionSuffix': 'Rokcode will need to reload.',
  ...
  'settings.mcp.page.toast.serverCreatedReloadFailed': 'MCP server created, but Rokcode reload failed.',
  'settings.mcp.page.toast.savedReloadFailed': 'Saved, but Rokcode reload failed.',
  'settings.mcp.page.toast.retryRefreshHint': 'Retry refresh or reopen Settings before authorizing this server.',
  'settings.mcp.page.toast.serverCreatedReloading': 'MCP server created. Rokcode reloading…',
  'settings.mcp.page.toast.savedReloading': 'Saved. Rokcode reloading…',
  'settings.mcp.page.toast.saveFailed': 'Failed to save',
  'settings.mcp.page.toast.unexpectedError': 'An error occurred',
  'settings.mcp.page.toast.serverDeletedReloadFailed': '"{name}" deleted, but Rokcode reload failed',
  ...
  'settings.mcp.page.toast.openCodeReloadFailedAfterCallbackSave': 'Rokcode reload failed after saving the browser callback URL',
  ...
  'settings.rok-desktop.defaults.title': 'Session Defaults',
  'settings.rok-desktop.defaults.summaryPrefix': 'New sessions will start with:',
  'settings.rok-desktop.defaults.summaryOpenCodeDefault': 'Rokcode agent default',
  'settings.rok-desktop.defaults.field.defaultModel': 'Default Model',
  'settings.rok-desktop.defaults.field.defaultThinking': 'Default Thinking',
  'settings.rok-desktop.defaults.field.thinkingPlaceholder': 'Thinking',
  'settings.rok-desktop.defaults.field.defaultAgent': 'Default Agent',
  'settings.rok-desktop.defaults.field.showDeletionDialogAria': 'Show deletion dialog',
  'settings.rok-desktop.defaults.field.showDeletionDialog': 'Show Deletion Dialog',
  'settings.rok-desktop.defaults.field.openFilesPreviewAria': 'Open files in preview mode',
  'settings.rok-desktop.defaults.field.openFilesPreview': 'Open files in preview mode',
  'settings.rok-desktop.defaults.option.default': 'Default',
  'settings.rok-desktop.defaults.option.defaultLowercase': 'default',
  'settings.rok-desktop.git.title': 'Git Preferences',
  'settings.rok-desktop.git.changesViewTitle': 'Changes View',
  'settings.rok-desktop.git.changesViewAria': 'Git changes view mode',
  'settings.rok-desktop.git.option.flatList': 'Flat List',
  'settings.rok-desktop.git.option.treeView': 'Tree View',
  'settings.rok-desktop.git.optionAria': 'Git changes view mode: {option}',
  'settings.rok-desktop.git.enableGitmojiAria': 'Enable Gitmoji picker',
  'settings.rok-desktop.git.enableGitmoji': 'Enable Gitmoji Picker',
  'settings.rok-desktop.git.showGitignoredAria': 'Display gitignored files',
  'settings.rok-desktop.git.showGitignored': 'Display Gitignored Files',
  ...
  'settings.github.page.flow.title': 'Authorize Rok Desktop',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Available as fallback if Rok Desktop auth is removed',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from Rok Desktop.',
  ...
  'settings.rok-desktop.visual.section.colorMode': 'Color Mode',
  'settings.rok-desktop.visual.section.mobileLayout': 'Mobile Layout',
  'settings.rok-desktop.visual.option.mobileLayout.default': 'Old',
  'settings.rok-desktop.visual.option.mobileLayout.new': 'New',
  'settings.rok-desktop.visual.section.localization': 'Localization',
  'settings.rok-desktop.visual.section.spacingAndLayout': 'Spacing & Layout',
  'settings.rok-desktop.visual.section.navigation': 'Navigation',
  'settings.rok-desktop.visual.section.chatRenderMode': 'Chat Render Mode',
  'settings.rok-desktop.visual.section.chatRenderModeAria': 'Chat render mode',
  'settings.rok-desktop.visual.section.messageStreamTransport': 'Message Stream Transport',
  'settings.rok-desktop.visual.section.activityDefault': 'Activity Default',
  'settings.rok-desktop.visual.section.activityDefaultAria': 'Activity default mode',
  'settings.rok-desktop.visual.section.showToolsOpenedByDefault': 'Show tools opened by default:',
  'settings.rok-desktop.visual.section.userMessageRendering': 'User Message Rendering',
  'settings.rok-desktop.visual.section.userMessageRenderingAria': 'User message rendering mode',
  'settings.rok-desktop.visual.section.mermaidRendering': 'Mermaid Rendering',
  'settings.rok-desktop.visual.section.mermaidRenderingAria': 'Mermaid rendering mode',
  'settings.rok-desktop.visual.section.diffLayout': 'Diff Layout',
  'settings.rok-desktop.visual.section.diffLayoutAria': 'Diff layout',
  'settings.rok-desktop.visual.section.privacy': 'Privacy',
  'settings.rok-desktop.visual.field.lightTheme': 'Light Theme',
  'settings.rok-desktop.visual.field.darkTheme': 'Dark Theme',
  'settings.rok-desktop.visual.field.selectLightThemeAria': 'Select light theme',
  'settings.rok-desktop.visual.field.selectDarkThemeAria': 'Select dark theme',
  'settings.rok-desktop.visual.field.selectThemePlaceholder': 'Select theme',
  'settings.rok-desktop.visual.field.timeFormat': 'Time Format',
  'settings.rok-desktop.visual.field.weekStartsOn': 'Week Starts On',
  'settings.rok-desktop.visual.field.selectTimeFormatAria': 'Select time format',
  'settings.rok-desktop.visual.field.selectWeekStartAria': 'Select week start',
  'settings.rok-desktop.visual.actions.reloadThemes': 'Reload themes',
  'settings.rok-desktop.visual.actions.reloadingThemes': 'Reloading themes...',
  'settings.rok-desktop.visual.field.macVibrancy': 'Window transparency',
  'settings.rok-desktop.visual.field.macVibrancyHint': 'Use the native macOS blur (vibrancy) behind the sidebar. Turn off for fully solid, opaque surfaces.',
  'settings.rok-desktop.visual.field.dockBadge': 'Dock badge',
  'settings.rok-desktop.visual.field.dockBadgeHint': 'Show a count of chats with unseen activity on the macOS dock icon.',
  'settings.rok-desktop.visual.actions.saveAndRestart': 'Save & restart',
  'settings.rok-desktop.visual.actions.restarting': 'Restarting…',
  'settings.rok-desktop.visual.field.themeImportInfoAria': 'Theme import info',
  'settings.rok-desktop.visual.field.themeImportInfoTooltip': 'Import custom themes from ~/.config/rok-desktop/themes/',
  'settings.rok-desktop.visual.field.installAppName': 'Install App Name',
  'settings.rok-desktop.visual.field.installAppNameHint': 'Used by PWA installation process.',
  'settings.rok-desktop.visual.field.pwaInstallAppNameAria': 'PWA install app name',
  'settings.rok-desktop.visual.actions.resetInstallAppNameAria': 'Reset install app name',
  'settings.rok-desktop.visual.field.installOrientation': 'Install Orientation',
  'settings.rok-desktop.visual.field.installOrientationHint': 'Used by the installed web app. Reinstall the PWA after changing this.',
  'settings.rok-desktop.visual.field.pwaInstallOrientationAria': 'PWA install orientation',
  'settings.rok-desktop.visual.field.selectOrientationPlaceholder': 'Select orientation',
  'settings.rok-desktop.visual.actions.resetInstallOrientationAria': 'Reset install orientation',
  'settings.rok-desktop.visual.field.mobileKeyboardMode': 'Mobile Keyboard Behavior',
  'settings.rok-desktop.visual.field.mobileKeyboardModeHint': 'Default browser behavior is safest. Resize content asks supported browsers to shrink the app when the on-screen keyboard opens.',
  'settings.rok-desktop.visual.field.mobileKeyboardModeAria': 'Mobile keyboard behavior',
  'settings.rok-desktop.visual.field.selectMobileKeyboardModePlaceholder': 'Select keyboard behavior',
  'settings.rok-desktop.visual.actions.resetMobileKeyboardModeAria': 'Reset mobile keyboard behavior',
  'settings.rok-desktop.visual.field.interfaceFontSize': 'Interface Font Size',
  'settings.rok-desktop.visual.field.interfaceFont': 'Interface Font',
  'settings.rok-desktop.visual.field.selectInterfaceFontAria': 'Select interface font',
  'settings.rok-desktop.visual.actions.resetInterfaceFontAria': 'Reset interface font',
  'settings.rok-desktop.visual.field.fontSizePercentageAria': 'Font size percentage',
  'settings.rok-desktop.visual.actions.resetFontSizeAria': 'Reset font size',
  'settings.rok-desktop.visual.field.terminalFontSize': 'Terminal Font Size',
  'settings.rok-desktop.visual.field.codeFont': 'Code Font',
  'settings.rok-desktop.visual.field.selectCodeFontAria': 'Select code font',
  'settings.rok-desktop.visual.actions.resetCodeFontAria': 'Reset code font',
  'settings.rok-desktop.visual.actions.resetTerminalFontSizeAria': 'Reset terminal font size',
  'settings.rok-desktop.visual.field.spacingDensity': 'Spacing Density',
  'settings.rok-desktop.visual.actions.resetSpacingAria': 'Reset spacing',
  'settings.rok-desktop.visual.field.inputBarOffset': 'Input Bar Offset',
  'settings.rok-desktop.visual.field.inputBarOffsetTooltip': 'Raise input bar to avoid OS-level screen obstructions like home bars.',
  'settings.rok-desktop.visual.actions.resetInputBarOffsetAria': 'Reset input bar offset',
  'settings.rok-desktop.visual.field.terminalQuickKeysAria': 'Terminal quick keys',
  'settings.rok-desktop.visual.field.terminalQuickKeys': 'Terminal Quick Keys',
  'settings.rok-desktop.visual.field.terminalQuickKeysTooltip': 'Show Esc, Ctrl, Arrows in terminal view',
  'settings.rok-desktop.visual.field.fileEditorKeymap': 'File editor keymap',
  'settings.rok-desktop.visual.option.fileEditorKeymap.default': 'Default',
  'settings.rok-desktop.visual.option.fileEditorKeymap.vim': 'Vim',
  'settings.rok-desktop.visual.field.activityDefaultModeAria': 'Activity default mode: {option}',
  'settings.rok-desktop.visual.field.showExpandedBashToolsAria': 'Show expanded bash tools',
  'settings.rok-desktop.visual.field.showExpandedEditToolsAria': 'Show expanded edit tools',
  'settings.rok-desktop.visual.field.bash': 'Bash',
  'settings.rok-desktop.visual.field.editTools': 'Edit tools',
  'settings.rok-desktop.visual.field.userMessageRenderingAria': 'User message rendering: {option}',
  'settings.rok-desktop.visual.field.mermaidRenderingAria': 'Mermaid rendering: {option}',
  'settings.rok-desktop.visual.field.diffLayoutAria': 'Diff layout: {option}',
  'settings.rok-desktop.visual.field.showReasoningTracesAria': 'Show reasoning traces',
  'settings.rok-desktop.visual.field.showReasoningTraces': 'Show Reasoning Traces',
  'settings.rok-desktop.visual.field.collapsibleThinkingBlocksAria': 'Enable collapsible reasoning blocks',
  'settings.rok-desktop.visual.field.collapsibleThinkingBlocks': 'Enable Collapsible Reasoning Blocks',
  'settings.rok-desktop.visual.field.collapsibleUserMessagesAria': 'Collapse long user messages',
  'settings.rok-desktop.visual.field.collapsibleUserMessages': 'Collapse Long User Messages',
  'settings.rok-desktop.visual.field.stickyUserHeaderAria': 'Sticky user header',
  'settings.rok-desktop.visual.field.stickyUserHeader': 'Sticky User Header',
  ...
  'settings.rok-desktop.visual.field.wideChatLayoutAria': 'Wide chat layout',
  'settings.rok-desktop.visual.field.wideChatLayout': 'Wide Chat Layout',
  'settings.rok-desktop.visual.field.showSplitAssistantMessageActionsAria': 'Inline assistant actions',
  'settings.rok-desktop.visual.field.showSplitAssistantMessageActions': 'Inline Assistant Actions',
  'settings.rok-desktop.visual.field.showSplitAssistantMessageActionsTooltip': 'Show Copy Answer, Save as image, and Read aloud on assistant text blocks that appear before later tool calls in the same response.',
  'settings.rok-desktop.visual.field.showToolFileIconsAria': 'Show tool file icons',
  'settings.rok-desktop.visual.field.showToolFileIcons': 'Show Tool File Icons',
  'settings.rok-desktop.visual.field.showTurnChangedFilesAria': 'Show changed files for completed turns',
  'settings.rok-desktop.visual.field.showTurnChangedFiles': 'Show Changed Files for Completed Turns',
  'settings.rok-desktop.visual.field.showDotfilesAria': 'Show dotfiles',
  'settings.rok-desktop.visual.field.showDotfiles': 'Show Dotfiles',
  'settings.rok-desktop.visual.field.queueMessagesByDefaultAria': 'Queue messages by default',
  'settings.rok-desktop.visual.field.queueMessagesByDefault': 'Queue Messages by Default',
  'settings.rok-desktop.visual.field.queueMessagesByDefaultTooltip': 'When enabled, Enter queues messages. Use {modifier}+Enter to send.',
  'settings.rok-desktop.visual.field.persistDraftMessagesAria': 'Persist draft messages',
  'settings.rok-desktop.visual.field.persistDraftMessages': 'Persist Draft Messages',
  'settings.rok-desktop.visual.field.enableSpellcheckInTextInputsAria': 'Enable spellcheck in text inputs',
  'settings.rok-desktop.visual.field.enableSpellcheckInTextInputs': 'Enable Spellcheck in Text Inputs',
  'settings.rok-desktop.visual.field.sendAnonymousUsageReportsAria': 'Send anonymous usage reports',
  'settings.rok-desktop.visual.field.sendAnonymousUsageReports': 'Send anonymous usage reports',
  'settings.rok-desktop.visual.field.sendAnonymousUsageReportsHint': 'Helps us understand which app versions are actively used so we can prioritize improvements. Only app version, platform, and runtime are collected - no personal data or code.',
  'settings.rok-desktop.visual.option.themeMode.system': 'System',
  'settings.rok-desktop.visual.option.themeMode.light': 'Light',
  'settings.rok-desktop.visual.option.themeMode.dark': 'Dark',
  'settings.rok-desktop.visual.option.diffLayout.dynamic.label': 'Dynamic',
  'settings.rok-desktop.visual.option.diffLayout.dynamic.description': 'New inline, modified side-by-side.',
  'settings.rok-desktop.visual.option.diffLayout.inline.label': 'Always inline',
  'settings.rok-desktop.visual.option.diffLayout.inline.description': 'Show as a single unified view.',
  'settings.rok-desktop.visual.option.diffLayout.sideBySide.label': 'Always side-by-side',
  'settings.rok-desktop.visual.option.diffLayout.sideBySide.description': 'Compare original and modified files.',
  'settings.rok-desktop.visual.option.mermaidRendering.svg.label': 'SVG',
  'settings.rok-desktop.visual.option.mermaidRendering.svg.description': 'Render diagrams as scalable graphics.',
  'settings.rok-desktop.visual.option.mermaidRendering.ascii.label': 'ASCII',
  'settings.rok-desktop.visual.option.mermaidRendering.ascii.description': 'Render diagrams as text blocks.',
  'settings.rok-desktop.visual.option.pwaOrientation.system.label': 'Follow system',
  'settings.rok-desktop.visual.option.pwaOrientation.system.description': 'Respect the device rotation setting.',
  'settings.rok-desktop.visual.option.pwaOrientation.portrait.label': 'Portrait lock',
  'settings.rok-desktop.visual.option.pwaOrientation.portrait.description': 'Install the app locked to portrait.',
  'settings.rok-desktop.visual.option.pwaOrientation.landscape.label': 'Landscape lock',
  'settings.rok-desktop.visual.option.pwaOrientation.landscape.description': 'Install the app locked to landscape.',
  'settings.rok-desktop.visual.option.mobileKeyboardMode.native.label': 'Follow browser',
  'settings.rok-desktop.visual.option.mobileKeyboardMode.native.description': 'Use the browser default for panning and viewport changes when the keyboard opens.',
  'settings.rok-desktop.visual.option.mobileKeyboardMode.resizeContent.label': 'Resize content',
  'settings.rok-desktop.visual.option.mobileKeyboardMode.resizeContent.description': 'Ask supported browsers to shrink the app layout instead of relying only on panning.',
  'settings.rok-desktop.visual.option.userMessageRendering.markdown.label': 'Markdown',
  'settings.rok-desktop.visual.option.userMessageRendering.markdown.description': 'Render user text with markdown formatting.',
  'settings.rok-desktop.visual.option.userMessageRendering.plain.label': 'Plain text',
  'settings.rok-desktop.visual.option.userMessageRendering.plain.description': 'Render user text with preserved whitespace and links.',
  'chat.message.userText.collapseAria': 'Collapse user message',
  'settings.rok-desktop.visual.option.chatRenderMode.sorted.label': 'Sorted',
  'settings.rok-desktop.visual.option.chatRenderMode.sorted.description': 'Render completed assistant messages without live streaming.',
  'settings.rok-desktop.visual.option.chatRenderMode.live.label': 'Live',
  'settings.rok-desktop.visual.option.chatRenderMode.live.description': 'Stream assistant text and tools as they arrive.',
  'settings.rok-desktop.visual.option.messageTransport.auto.label': 'Auto',
  'settings.rok-desktop.visual.option.messageTransport.auto.description': 'Prefer WebSocket and fall back to SSE if needed.',
  'settings.rok-desktop.visual.option.messageTransport.ws.label': 'WebSocket',
  'settings.rok-desktop.visual.option.messageTransport.ws.description': 'Use WebSocket for message streaming.',
  'settings.rok-desktop.visual.option.messageTransport.sse.label': 'SSE',
  'settings.rok-desktop.visual.option.messageTransport.sse.description': 'Use Server-Sent Events for message streaming.',
  'settings.rok-desktop.visual.option.activityRenderMode.collapsed.label': 'Collapsed',
  'settings.rok-desktop.visual.option.activityRenderMode.collapsed.description': 'Keep Activity collapsed by default.',
  'settings.rok-desktop.visual.option.activityRenderMode.summary.label': 'Expanded',
  'settings.rok-desktop.visual.option.activityRenderMode.summary.description': 'Expand Activity by default.',
  'settings.rok-desktop.visual.option.timeFormat.auto.label': 'Auto',
  'settings.rok-desktop.visual.option.timeFormat.auto.description': 'Use system locale preference.',
  'settings.rok-desktop.visual.option.timeFormat.24h.label': '24-hour',
  'settings.rok-desktop.visual.option.timeFormat.24h.description': 'Show time as 14:15.',
  'settings.rok-desktop.visual.option.timeFormat.12h.label': '12-hour',
  'settings.rok-desktop.visual.option.timeFormat.12h.description': 'Show time as 02:15 PM.',
  'settings.rok-desktop.visual.option.weekStart.auto.label': 'Auto',
  'settings.rok-desktop.visual.option.weekStart.auto.description': 'Use locale week start.',
  'settings.rok-desktop.visual.option.weekStart.monday.label': 'Monday',
  'settings.rok-desktop.visual.option.weekStart.sunday.label': 'Sunday',
