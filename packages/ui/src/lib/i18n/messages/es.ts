...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instala Rok Desktop para acceder más rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Descartar",
  "pwa.installPrompt.started": "Instalación iniciada",
  "pwa.installPrompt.installed": "Rok Desktop se instaló",
  ...
  "mobile.connect.welcome.title": "Conéctate a Rok Desktop",
  ...
  "mobile.connect.password.placeholder": "Contraseña de Rok Desktop",
  ...
  "mobile.connect.scan.invalid": "Ese código QR no es un código de conexión de Rok Desktop.",
  ...
  "mobile.connect.error.unreachable": "No se pudo conectar con ese servidor de Rok Desktop.",
  ...
  "sessions.sidebar.footer.actions.aboutRok Desktop": "Acerca de Rok Desktop",
  ...
  "contextPanel.browser.trustNotice": "Las páginas que abras aquí se ejecutan con acceso completo a Rok Desktop: necesario para la inspección y las capturas. Abre solo sitios de confianza: una página maliciosa podría leer tus datos o actuar en tu nombre.",
  ...
  "header.services.shutdownDev": "Detener Rok Desktop",
  ...
  "aboutDialog.openChamberVersionLabel": "Versión de Rok Desktop {version}",
  "aboutDialog.openCodeVersionLabel": "Versión de Rokcode {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de Rok Desktop, el estado de Rokcode, directorios y proyectos.",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por Rok Desktop de manera eficiente",
  ...
  "header.actions.openAppMenu": "Menú de Rok Desktop",
  "header.actions.openAppMenuAria": "Abrir menú de Rok Desktop",
  ...
  "chat.emptyState.rokcodeUnreachable": "Rokcode no es accesible",
  ...
  "openCodeStatusDialog.title": "Estado de Rokcode",
  "openCodeStatusDialog.description": "Inspecciona el estado actual de Rokcode y diagnósticos.",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear Rok Desktop",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de Rok Desktop",
  ...
  "multiRun.window.description": "Ventana de Rok Desktop Multi-Run.",
  ...
  "onboarding.chooser.title": "Bienvenido a Rok Desktop",
  ...
  "onboarding.localSetup.title": "Configuración de Rokcode",
  "onboarding.localSetup.description": "Instala la CLI de Rokcode para continuar.",
  "onboarding.localSetup.dialog.selectRokcodeBinary": "Seleccionar ejecutable de rokcode",
  "onboarding.localSetup.errors.cliNotReady": "La CLI de Rokcode aún no está lista. Confirma que la instalación está completa y intenta de nuevo.",
  ...
  "onboarding.localSetup.windows.stepInstallWsl": "Instala Rokcode con el comando siguiente.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si Rok Desktop no detecta Rokcode automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "Rokcode es el corazón de Rok Desktop. Instálalo para empezar.",
  "onboarding.localSetup.docs.windows": "Documentación de Rokcode",
  "onboarding.localSetup.docs.default": "Documentación de Rokcode",
  ...
  "onboarding.localSetup.helper.checkAndContinue": "Haz clic para verificar si la CLI de Rokcode está disponible. Si la verificación funciona, entrarás automáticamente en la pantalla principal.",
  "onboarding.localSetup.status.watching": "Esperando Rokcode",
  "onboarding.localSetup.status.autoContinue": "Continuaremos automáticamente al detectarlo.",
  "onboarding.localSetup.field.alreadyInstalled": "¿Ya está instalado? Establece la ruta de la CLI de Rokcode:",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de Rok Desktop y recarga la configuración de Rokcode.",
  ...
  "onboarding.localSetup.windows.hintInstallInWsl": "En Windows, instala y ejecuta Rokcode de forma nativa.",
  "onboarding.localSetup.windows.hintDetectionFailed": "Si la detección falla, establece una ruta nativa como rokcode.cmd u rokcode.exe.",
  "onboarding.localSetup.hint.ensurePath": "¿Ya está instalado? Asegúrate de que rokcode esté en tu PATH.",
  "onboarding.localSetup.hint.setEnv": "O establece la variable de entorno ROKCODE_BINARY.",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de Rok Desktop para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor Rok Desktop o contacta al administrador del servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instancia ejecuta una versión diferente de Rok Desktop. Puedes conectarte, pero actualiza ambas apps si algo no funciona.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "El servidor ejecuta Rok Desktop pero no es compatible con esta versión de la app. Actualiza Rok Desktop en el servidor y vuelve a intentarlo.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando Rok Desktop. Verifica que la dirección apunte a un servidor Rok Desktop.",
  ...
  "onboarding.desktopRecovery.localUnavailable.title": "Rokcode Local no disponible",
  "onboarding.desktopRecovery.localUnavailable.description": "La CLI de Rokcode no pudo iniciarse o no está instalado. Instala Rokcode o conecta a un servidor remoto en su lugar.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "El servidor en \"{host}\" no está ejecutando Rok Desktop. Verifica que la dirección apunte a un servidor Rok Desktop.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Actualización del servidor requerida",
  "onboarding.desktopRecovery.remoteIncompatible.description": "El servidor Rok Desktop en \"{host}\" no es compatible con esta versión de la app. Actualiza Rok Desktop en el servidor y vuelve a intentarlo.",
  ...
  "startup.initRecovery.description": "Rok Desktop no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  ...
  "updateDialog.header.updating": "Actualizando Rok Desktop...",
  ...
  "updateDialog.error.takingLonger": "La actualización está tardando más de lo esperado. Espera un poco y refresca, o ejecuta: rok-desktop update",
  "rokcodeUpdate.toast.available.title": "Actualización de Rokcode",
  "rokcodeUpdate.toast.available.description": "Versión {version} disponible.",
  "rokcodeUpdate.toast.actions.update": "Actualizar",
  "rokcodeUpdate.toast.actions.dismiss": "Descartar",
  "rokcodeUpdate.toast.actions.reload": "Recargar Rokcode",
  "rokcodeUpdate.toast.upgrading.title": "Actualizando Rokcode...",
  "rokcodeUpdate.toast.upgrading.description": "Mantén Rok Desktop abierto.",
  "rokcodeUpdate.toast.updated.title": "Rokcode actualizado",
  "rokcodeUpdate.toast.updated.description": "Actualización instalada.",
  "rokcodeUpdate.toast.updated.descriptionWithVersion": "Versión {version} instalada.",
  "rokcodeUpdate.toast.failed.title": "No se pudo actualizar Rokcode",
  "rokcodeUpdate.toast.failed.description": "La actualización de Rokcode falló.",
  "rokcodeUpdate.toast.reload.message": "Reiniciando Rokcode...",
  ...
  "openChamberLogo.aria.logo": "Logo de Rok Desktop",
