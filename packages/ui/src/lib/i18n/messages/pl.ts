...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'Zainstaluj Rok Desktop, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'Rok Desktop został zainstalowany',
  ...
  'mobile.connect.welcome.title': 'Połącz z Rok Desktop',
  ...
  'mobile.connect.password.placeholder': 'Hasło Rok Desktop',
  ...
  'mobile.connect.scan.invalid': 'Ten kod QR nie jest kodem połączenia Rok Desktop.',
  ...
  'mobile.connect.error.unreachable': 'Nie udało się połączyć z tym serwerem Rok Desktop.',
  ...
  'sessions.sidebar.footer.actions.aboutRok Desktop': 'O Rok Desktop',
  ...
  'chat.emptyState.rokcodeUnreachable': 'Rokcode jest nieosiągalny',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia Rok Desktop.',
  ...
  'onboarding.chooser.title': 'Witaj w Rok Desktop',
  ...
  'onboarding.localSetup.title': 'Konfiguracja Rokcode',
  'onboarding.localSetup.description': 'Zainstaluj CLI Rokcode aby kontynuować.',
  'onboarding.localSetup.dialog.selectRokcodeBinary': 'Wybierz binarkę rokcode',
  'onboarding.localSetup.errors.cliNotReady': 'Rokcode CLI nie jest jeszcze gotowy. Potwierdź, że instalacja jest kompletna i spróbuj ponownie.',
  ...
  'onboarding.localSetup.windows.stepInstallWsl': 'Zainstaluj Rokcode za pomocą poniższego polecenia.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli Rok Desktop nie wykryje Rokcode automatycznie, ustaw ścieżkę binarki poniżej.',
  'onboarding.localSetup.docs.windows': 'Dokumentacja Rokcode',
  'onboarding.localSetup.docs.default': 'Wyświetl dokumentację',
  'onboarding.localSetup.actions.checking': 'Sprawdzanie...',
  'onboarding.localSetup.helper.checkAndContinue': 'Kliknij aby sprawdzić czy Rokcode CLI jest dostępny. Jeśli się uda, automatycznie przejdziesz do głównego ekranu.',
  'onboarding.localSetup.field.alreadyInstalled': 'Juz zainstalowane? Ustaw ścieżkę binarki Rokcode:',
  'onboarding.localSetup.actions.browse': 'Przeglądaj',
  'onboarding.localSetup.actions.apply': 'Zastosuj',
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień Rok Desktop i przeładowuje konfigurację Rokcode.',
  ...
  'onboarding.localSetup.windows.hintInstallInWsl': 'W Windows zainstaluj i uruchom Rokcode natywnie.',
  'onboarding.localSetup.windows.hintDetectionFailed': 'Jeśli wykrywanie nie powiedzie się, ustaw natywną ścieżkę, np. rokcode.cmd lub rokcode.exe.',
  'onboarding.localSetup.hint.ensurePath': 'Juz zainstalowane? Upewnij się, że rokcode jest w twoim PATH.',
  'onboarding.localSetup.hint.setEnv': 'Lub ustaw zmienną środowiskową ROKCODE_BINARY.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera Rok Desktop aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer Rok Desktop, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Ta instancja używa innej wersji Rok Desktop. Możesz się połączyć, ale zaktualizuj obie aplikacje, jeśli coś nie działa.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Serwer uruchamia Rok Desktop, ale nie jest zgodny z tą wersją aplikacji. Zaktualizuj Rok Desktop na serwerze i spróbuj ponownie.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim Rok Desktop. Zweryfikuj czy adres wskazuje na serwer Rok Desktop.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'Rokcode lokalny niedostępny',
  'onboarding.desktopRecovery.localUnavailable.description': 'Nie można było uruchomić Rokcode CLI lub nie jest zainstalowany. Zainstaluj Rokcode lub połącz się z serwerem zdalnym.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia Rok Desktop. Zweryfikuj czy adres wskazuje na serwer Rok Desktop.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Wymagana aktualizacja serwera',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Serwer Rok Desktop pod adresem "{host}" nie jest zgodny z tą wersją aplikacji. Zaktualizuj Rok Desktop na serwerze i spróbuj ponownie.',
  ...
  'startup.initRecovery.description': 'Rok Desktop nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan Rok Desktop, kondycję Rokcode, katalogi i projekty.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Wersja Rok Desktop {version}',
  'aboutDialog.openCodeVersionLabel': 'Wersja Rokcode {version}',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do Rok Desktop — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami Rok Desktop',
  ...
  'header.actions.openAppMenu': 'Menu Rok Desktop',
  'header.actions.openAppMenuAria': 'Otwórz menu Rok Desktop',
  ...
  'header.services.shutdownDev': 'Zatrzymaj Rok Desktop',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po Rok Desktop.',
  ...
  'openChamberLogo.aria.logo': 'Logo Rok Desktop',
  'openCodeStatusDialog.actions.copy': 'Kopiuj',
  'openCodeStatusDialog.description': 'Sprawdź bieżący status i diagnostykę Rokcode.',
  'openCodeStatusDialog.empty.noData': 'Brak danych.',
  'openCodeStatusDialog.title': 'Status Rokcode',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj Rok Desktop',
  ...
  'updateDialog.error.takingLonger': 'Aktualizacja trwa dłużej niż oczekiwano. Poczekaj chwilę i odśwież albo uruchom: rok-desktop update',
  ...
  'updateDialog.header.updating': 'Aktualizowanie Rok Desktop...',
  ...
  'rokcodeUpdate.toast.available.title': 'Aktualizacja Rokcode',
  'rokcodeUpdate.toast.available.description': 'Wersja {version} dostępna.',
  'rokcodeUpdate.toast.actions.update': 'Aktualizuj',
  'rokcodeUpdate.toast.actions.dismiss': 'Odrzuć',
  'rokcodeUpdate.toast.actions.reload': 'Przeładuj Rokcode',
  'rokcodeUpdate.toast.upgrading.title': 'Aktualizowanie Rokcode...',
  'rokcodeUpdate.toast.upgrading.description': 'Pozostaw Rok Desktop otwarte.',
  'rokcodeUpdate.toast.updated.title': 'Rokcode zaktualizowany',
  'rokcodeUpdate.toast.updated.description': 'Aktualizacja zainstalowana.',
  'rokcodeUpdate.toast.updated.descriptionWithVersion': 'Wersja {version} zainstalowana.',
  'rokcodeUpdate.toast.failed.title': 'Nie udało się zaktualizować Rokcode',
  'rokcodeUpdate.toast.failed.description': 'Aktualizacja Rokcode nie powiodła się.',
  'rokcodeUpdate.toast.reload.message': 'Ponowne uruchamianie Rokcode...',
  ...
  'onboarding.localSetup.intro': 'Rokcode to serce Rok Desktop — zainstaluj je, aby zacząć.',
  'onboarding.localSetup.actions.checkNow': 'Sprawdź teraz',
  'onboarding.localSetup.status.watching': 'Czekanie na Rokcode',
  ...
  'settings.rok-desktop.keyboardShortcuts.action.open_timeline_dialog.label': 'Otwórz oś czasu',
  ...
  'settings.rok-desktop.visual.field.mobileKeyboardModeAria': 'Tryb klawiatury mobilnej',
  'settings.rok-desktop.visual.field.selectMobileKeyboardModePlaceholder': 'Wybierz tryb klawiatury mobilnej',
  'settings.rok-desktop.visual.actions.resetMobileKeyboardModeAria': 'Resetuj tryb klawiatury mobilnej',
  'settings.rok-desktop.visual.option.mobileKeyboardMode.native.label': 'Natywny',
  'settings.rok-desktop.visual.option.mobileKeyboardMode.native.description': 'Użyj domyślnego zachowania przeglądarki/systemu.',
  'settings.rok-desktop.visual.option.mobileKeyboardMode.resizeContent.label': 'Zmień rozmiar zawartości',
  'settings.rok-desktop.visual.option.mobileKeyboardMode.resizeContent.description': 'Dopasuj układ tak, aby zawartość pozostała widoczna ponad klawiaturą.',
