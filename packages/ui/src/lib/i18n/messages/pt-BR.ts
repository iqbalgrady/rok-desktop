...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "pwa.installPrompt.description": "Instale o Rok Desktop para acessar mais rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Dispensar",
  "pwa.installPrompt.started": "Instalação iniciada",
  "pwa.installPrompt.installed": "Rok Desktop instalado",
  ...
  "mobile.connect.welcome.title": "Conectar ao Rok Desktop",
  ...
  "mobile.connect.password.placeholder": "Senha do Rok Desktop",
  ...
  "mobile.connect.scan.invalid": "Esse código QR não é um código de conexão do Rok Desktop.",
  ...
  "mobile.connect.error.unreachable": "Não foi possível acessar esse servidor Rok Desktop.",
  ...
  "sessions.sidebar.footer.actions.aboutRok Desktop": "Sobre o Rok Desktop",
  ...
  "contextPanel.browser.trustNotice": "As páginas abertas aqui são executadas com acesso total ao Rok Desktop — necessário para inspeção e capturas de tela. Abra apenas sites confiáveis: uma página maliciosa pode ler seus dados ou agir em seu nome.",
  ...
  "header.services.shutdownDev": "Parar Rok Desktop",
  ...
  "aboutDialog.openChamberVersionLabel": "Versão do Rok Desktop {version}",
  "aboutDialog.openCodeVersionLabel": "Versão do Rokcode {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do Rok Desktop, a integridade do Rokcode, diretórios e projetos.",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo Rok Desktop com eficiência",
  ...
  "header.actions.openAppMenu": "Menu do Rok Desktop",
  "header.actions.openAppMenuAria": "Abrir menu do Rok Desktop",
  ...
  "chat.emptyState.rokcodeUnreachable": "Rokcode não está acessível",
  ...
  "openCodeStatusDialog.title": "Status do Rokcode",
  "openCodeStatusDialog.description": "Inspecione o status atual do Rokcode e os diagnósticos.",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do Rok Desktop",
  ...
  "multiRun.window.description": "Janela do Rok Desktop Multi-Run.",
  ...
  "onboarding.chooser.title": "Boas-vindas ao Rok Desktop",
  ...
  "onboarding.localSetup.title": "Configuração do Rokcode",
  "onboarding.localSetup.description": "Instale a CLI do Rokcode para continuar.",
  "onboarding.localSetup.dialog.selectRokcodeBinary": "Selecionar executável de rokcode",
  "onboarding.localSetup.errors.cliNotReady": "A CLI do Rokcode ainda não está pronta. Confirme que a instalação está completa e tente novamente.",
  "onboarding.localSetup.errors.detectionFailed": "Erro de detecção",
  "onboarding.localSetup.windows.title": "Configuração no Windows",
  "onboarding.localSetup.windows.stepInstallWsl": "Instale o Rokcode com o comando abaixo.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o Rok Desktop não detectar o Rokcode automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "Rokcode é o coração do Rok Desktop. Instale-o para começar.",
  "onboarding.localSetup.docs.windows": "Documentação do Rokcode",
  "onboarding.localSetup.docs.default": "Documentação do Rokcode",
  ...
  "onboarding.localSetup.helper.checkAndContinue": "Clique para verificar se a CLI do Rokcode está disponível. Se a verificação funcionar, você entrará automaticamente na tela principal.",
  "onboarding.localSetup.status.watching": "Aguardando Rokcode",
  "onboarding.localSetup.status.autoContinue": "Continuaremos automaticamente assim que detectado.",
  "onboarding.localSetup.field.alreadyInstalled": "Já está instalado? Defina o caminho da CLI do Rokcode:",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do Rok Desktop e recarregue configurações do Rokcode.",
  ...
  "onboarding.localSetup.windows.hintInstallInWsl": "No Windows, instale e execute o Rokcode nativamente.",
  "onboarding.localSetup.windows.hintDetectionFailed": "Se a detecção falhar, defina um caminho nativo, como rokcode.cmd ou rokcode.exe.",
  "onboarding.localSetup.hint.ensurePath": "Já está instalado? Confira se rokcode está no seu PATH.",
  "onboarding.localSetup.hint.setEnv": "Ou defina a variável de ambiente ROKCODE_BINARY.",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do Rok Desktop para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor Rok Desktop ou entre em contato com o administrador do servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instância está executando uma versão diferente do Rok Desktop. Você pode se conectar, mas atualize os dois apps se algo não funcionar.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "O servidor está executando Rok Desktop, mas não é compatível com esta versão do app. Atualize o Rok Desktop no servidor e tente novamente.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando Rok Desktop. Verifique se o endereço aponta para um servidor Rok Desktop.",
  ...
  "onboarding.desktopRecovery.localUnavailable.title": "Rokcode Local não disponível",
  "onboarding.desktopRecovery.localUnavailable.description": "A CLI do Rokcode não pôde ser iniciada ou não está instalada. Instale o Rokcode ou conecte um servidor remoto no lugar dela.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "O servidor em \"{host}\" não está executando Rok Desktop. Verifique se o endereço aponta para um servidor Rok Desktop.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Atualização do servidor necessária",
  "onboarding.desktopRecovery.remoteIncompatible.description": "O servidor Rok Desktop em \"{host}\" não é compatível com esta versão do app. Atualize o Rok Desktop no servidor e tente novamente.",
  ...
  "startup.initRecovery.description": "O Rok Desktop não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",
  ...
  "updateDialog.header.updating": "Atualizando Rok Desktop...",
  ...
  "updateDialog.error.takingLonger": "A atualização está demorando mais do que o esperado. Aguarde um pouco e atualize, ou execute: rok-desktop update",
  "rokcodeUpdate.toast.available.title": "Atualização do Rokcode",
  "rokcodeUpdate.toast.available.description": "Versão {version} disponível.",
  "rokcodeUpdate.toast.actions.update": "Atualizar",
  "rokcodeUpdate.toast.actions.dismiss": "Dispensar",
  "rokcodeUpdate.toast.actions.reload": "Recarregar Rokcode",
  "rokcodeUpdate.toast.upgrading.title": "Atualizando Rokcode...",
  "rokcodeUpdate.toast.upgrading.description": "Mantenha o Rok Desktop aberto.",
  "rokcodeUpdate.toast.updated.title": "Rokcode atualizado",
  "rokcodeUpdate.toast.updated.description": "Atualização instalada.",
  "rokcodeUpdate.toast.updated.descriptionWithVersion": "Versão {version} instalada.",
  "rokcodeUpdate.toast.failed.title": "Não foi possível atualizar o Rokcode",
  "rokcodeUpdate.toast.failed.description": "A atualização do Rokcode falhou.",
  ...
  "openChamberLogo.aria.logo": "Logo do Rok Desktop",
