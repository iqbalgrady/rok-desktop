...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Install Rok Desktop for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.dismiss': 'Dismiss',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'Rok Desktop installed',
  ...
  'mobile.connect.welcome.title': 'Connect to Rok Desktop',
  ...
  'mobile.connect.password.placeholder': 'Rok Desktop password',
  ...
  'mobile.connect.scan.invalid': 'That QR code is not an Rok Desktop connection code.',
  ...
  'mobile.connect.error.unreachable': 'Could not reach that Rok Desktop server.',
  ...
  'sessions.sidebar.footer.actions.aboutRok Desktop': 'About Rok Desktop',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to Rok Desktop — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'header.services.shutdownDev': 'Stop Rok Desktop',
  ...
  'aboutDialog.openChamberVersionLabel': 'Rok Desktop version {version}',
  'aboutDialog.openCodeVersionLabel': 'Rokcode version {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes Rok Desktop state, Rokcode health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate Rok Desktop efficiently',
  ...
  'header.actions.openAppMenu': 'Rok Desktop menu',
  'header.actions.openAppMenuAria': 'Open Rok Desktop menu',
  ...
  'chat.emptyState.opencodeUnreachable': 'Rokcode is not reachable',
  ...
  'openCodeStatusDialog.title': 'Rokcode Status',
  'openCodeStatusDialog.description': 'Inspect current Rokcode status and diagnostics.',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock Rok Desktop',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote Rok Desktop servers',
  ...
  'multiRun.window.description': 'Rok Desktop Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to Rok Desktop',
  ...
  'onboarding.localSetup.title': 'Setting Up Rokcode',
  'onboarding.localSetup.description': 'Install Rokcode CLI to continue.',
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'Select rokcode binary',
  'onboarding.localSetup.errors.cliNotReady': 'Rokcode CLI is not ready yet. Please confirm installation is complete and try again.',
  'onboarding.localSetup.errors.detectionFailed': 'Detection failed',
  'onboarding.localSetup.windows.title': 'Windows setup',
  'onboarding.localSetup.windows.stepInstallWsl': 'Install Rokcode with the command below.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If Rok Desktop does not detect Rokcode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'Rokcode is the heart of Rok Desktop — install it to get started.',
  'onboarding.localSetup.docs.windows': 'Rokcode docs',
  'onboarding.localSetup.docs.default': 'Rokcode docs',
  ...
  'onboarding.localSetup.helper.checkAndContinue': 'Click to check if Rokcode CLI is available. If successful, you\'ll automatically enter the main screen.',
  'onboarding.localSetup.status.watching': 'Waiting for Rokcode',
  'onboarding.localSetup.status.autoContinue': "We'll continue automatically once it's detected.",
  'onboarding.localSetup.field.alreadyInstalled': 'Already installed? Set the Rokcode CLI path:',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to Rok Desktop settings and reloads Rokcode configuration.',
  ...
  'onboarding.localSetup.windows.hintInstallInWsl': 'On Windows, install and run Rokcode natively.',
  'onboarding.localSetup.windows.hintDetectionFailed': 'If detection fails, set a native path such as rokcode.cmd or rokcode.exe.',
  'onboarding.localSetup.hint.ensurePath': 'Already installed? Make sure rokcode is in your PATH.',
  'onboarding.localSetup.hint.setEnv': 'Or set ROKCODE_BINARY environment variable.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an Rok Desktop server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an Rok Desktop server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different Rok Desktop version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running Rok Desktop but is not compatible with this app version. Update Rok Desktop on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running Rok Desktop. Verify the address points to an Rok Desktop server.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'Local Rokcode Unavailable',
  'onboarding.desktopRecovery.localUnavailable.description': 'Rokcode CLI could not be started or is not installed. Install Rokcode or connect to a remote server instead.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running Rok Desktop. Verify the address points to an Rok Desktop server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The Rok Desktop server at "{host}" is not compatible with this app version. Update Rok Desktop on the server, then try again.',
  ...
  'startup.initRecovery.description': 'Rok Desktop could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating Rok Desktop...',
  ...
  'updateDialog.error.takingLonger': 'Update is taking longer than expected. Wait a bit and refresh, or run: rok-desktop update',
  'rokcodeUpdate.toast.available.title': 'Rokcode update',
  'rokcodeUpdate.toast.available.description': 'Version {version} available.',
  'rokcodeUpdate.toast.actions.update': 'Update',
  'rokcodeUpdate.toast.actions.dismiss': 'Dismiss',
  'rokcodeUpdate.toast.actions.reload': 'Reload Rokcode',
  'rokcodeUpdate.toast.upgrading.title': 'Updating Rokcode...',
  'rokcodeUpdate.toast.upgrading.description': 'Keep Rok Desktop open.',
  'rokcodeUpdate.toast.updated.title': 'Rokcode updated',
  'rokcodeUpdate.toast.updated.description': 'Update installed.',
  'rokcodeUpdate.toast.updated.descriptionWithVersion': 'Version {version} installed.',
  'rokcodeUpdate.toast.failed.title': 'Could not update Rokcode',
  'rokcodeUpdate.toast.failed.description': 'The Rokcode upgrade failed.',
  'rokcodeUpdate.toast.reload.message': 'Restarting Rokcode...',
  ...
  'openChamberLogo.aria.logo': 'Rok Desktop logo',
