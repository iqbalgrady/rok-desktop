...
export const dict = {
  ...
  'aboutDialog.diagnosticsDescription': 'Includes Rok Desktop state, OpenCode health, directories, and projects.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If Rok Desktop does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of Rok Desktop — install it to get started.',
  ...
  'rokcodeUpdate.toast.actions.reload': 'Reload OpenCode',
  'rokcodeUpdate.toast.upgrading.title': 'Updating OpenCode...',
  ...
  'rokcodeUpdate.toast.failed.title': 'Could not update OpenCode',
  'rokcodeUpdate.toast.failed.description': 'The OpenCode upgrade failed.',
  'rokcodeUpdate.toast.reload.message': 'Restarting OpenCode...',
