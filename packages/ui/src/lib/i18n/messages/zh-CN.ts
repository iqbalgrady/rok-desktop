...
export const dict: Record<I18nKey, string> = {
  ...
  'aboutDialog.diagnosticsDescription': '包含 Rok Desktop 状态、OpenCode 健康信息、目录和项目。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 Rok Desktop 未自动检测到 OpenCode，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'OpenCode 是 Rok Desktop 的核心，先安装它即可开始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 Rok Desktop 设置并重新加载 OpenCode 配置。',
  ...
  'rokcodeUpdate.toast.actions.reload': '重载 OpenCode',
  ...
  'rokcodeUpdate.toast.failed.title': '无法更新 OpenCode',
  'rokcodeUpdate.toast.failed.description': 'OpenCode 升级失败。',
  'rokcodeUpdate.toast.reload.message': '正在重启 OpenCode...',
