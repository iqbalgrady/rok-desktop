...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安装 Rok Desktop 以便更快访问',
  'pwa.installPrompt.action': '安装',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已开始安装',
  'pwa.installPrompt.installed': 'Rok Desktop 已安装',
  ...
  'mobile.connect.welcome.title': '连接到 Rok Desktop',
  ...
  'mobile.connect.password.placeholder': 'Rok Desktop 密码',
  ...
  'mobile.connect.scan.invalid': '该二维码不是 Rok Desktop 连接码。',
  ...
  'mobile.connect.error.unreachable': '无法连接到该 Rok Desktop 服务器。',
  ...
  'sessions.sidebar.footer.actions.aboutRok Desktop': '关于 Rok Desktop',
  ...
  'contextPanel.browser.trustNotice': '在此打开的页面以对 Rok Desktop 的完全访问权限运行 — 检查和截图需要此权限。仅打开你信任的站点：恶意页面可能读取你的数据或以你的身份执行操作。',
  ...
  'aboutDialog.diagnosticsDescription': '包含 Rok Desktop 状态、Rokcode 健康信息、目录和项目。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 Rok Desktop',
  ...
  'header.actions.openAppMenu': 'Rok Desktop 菜单',
  'header.actions.openAppMenuAria': '打开 Rok Desktop 菜单',
  ...
  'chat.emptyState.rokcodeUnreachable': '无法连接 Rokcode',
  ...
  'openCodeStatusDialog.title': 'Rokcode 状态',
  'openCodeStatusDialog.description': '查看当前 Rokcode 状态与诊断信息。',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 Rok Desktop',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 Rok Desktop 服务器之间切换',
  ...
  'multiRun.window.description': 'Rok Desktop 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 Rok Desktop',
  ...
  'onboarding.localSetup.title': '设置 Rokcode',
  'onboarding.localSetup.description': '安装 Rokcode CLI 以继续。',
  'onboarding.localSetup.dialog.selectRokcodeBinary': '选择 Rokcode 可执行文件',
  'onboarding.localSetup.errors.cliNotReady': 'Rokcode CLI 尚未就绪。请确认安装完成后重试。',
  'onboarding.localSetup.errors.detectionFailed': '检测失败',
  'onboarding.localSetup.windows.title': 'Windows 设置',
  'onboarding.localSetup.windows.stepInstallWsl': '使用下方命令安装 Rokcode。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 Rok Desktop 未自动检测到 Rokcode，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'Rokcode 是 Rok Desktop 的核心，先安装它即可开始。',
  'onboarding.localSetup.docs.windows': 'Rokcode 文档',
  'onboarding.localSetup.docs.default': 'Rokcode 文档',
  ...
  'onboarding.localSetup.helper.checkAndContinue': '点击检测 Rokcode CLI 是否可用。成功后将自动进入主界面。',
  'onboarding.localSetup.status.watching': '正在等待 Rokcode',
  'onboarding.localSetup.status.autoContinue': '检测到后将自动继续。',
  'onboarding.localSetup.field.alreadyInstalled': '已安装？设置 Rokcode CLI 路径：',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 Rok Desktop 设置并重新加载 Rokcode 配置。',
  'onboarding.localSetup.remotePreference': '更希望使用远程服务器？',
  'onboarding.localSetup.actions.connectRemoteServer': '连接远程服务器 →',
  'onboarding.localSetup.windows.hintInstallInWsl': '在 Windows 上，请原生安装并运行 Rokcode。',
  'onboarding.localSetup.windows.hintDetectionFailed': '若检测失败，请设置原生路径，例如 rokcode.cmd 或 rokcode.exe。',
  'onboarding.localSetup.hint.ensurePath': '已安装？请确认 rokcode 在你的 PATH 中。',
  'onboarding.localSetup.hint.setEnv': '或设置 ROKCODE_BINARY 环境变量。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 Rok Desktop 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 Rok Desktop 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此实例正在运行不同版本的 Rok Desktop。你可以连接；如果功能异常，请更新两端应用。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '服务器正在运行 Rok Desktop，但与此应用版本不兼容。请更新服务器上的 Rok Desktop 后重试。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 Rok Desktop。请确认地址是否指向 Rok Desktop 服务器。',
  'onboarding.remoteConnection.probe.unreachableMessage': '服务器不可达。请检查网络连接并确认服务器地址。',
  'onboarding.desktopRecovery.localUnavailable.title': '本地 Rokcode 不可用',
  'onboarding.desktopRecovery.localUnavailable.description': 'Rokcode CLI 无法启动或未安装。请安装 Rokcode，或改为连接远程服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 Rok Desktop。请确认地址是否指向 Rok Desktop 服务器。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新服务器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '“{host}” 上的 Rok Desktop 服务器与此应用版本不兼容。请更新服务器上的 Rok Desktop 后重试。',
  ...
  'startup.initRecovery.description': 'Rok Desktop 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'updateDialog.error.takingLonger': '更新耗时超出预期。请稍等后刷新，或运行：rok-desktop update',
  'rokcodeUpdate.toast.available.title': 'Rokcode 更新',
  'rokcodeUpdate.toast.available.description': '版本 {version} 可用。',
  'rokcodeUpdate.toast.actions.update': '更新',
  'rokcodeUpdate.toast.actions.dismiss': '忽略',
  'rokcodeUpdate.toast.actions.reload': '重载 Rokcode',
  'rokcodeUpdate.toast.upgrading.title': '正在更新 Rokcode...',
  'rokcodeUpdate.toast.upgrading.description': '请保持 Rok Desktop 打开。',
  'rokcodeUpdate.toast.updated.title': 'Rokcode 已更新',
  'rokcodeUpdate.toast.updated.description': '更新已安装。',
  'rokcodeUpdate.toast.updated.descriptionWithVersion': '版本 {version} 已安装。',
  'rokcodeUpdate.toast.failed.title': '无法更新 Rokcode',
  'rokcodeUpdate.toast.failed.description': 'Rokcode 升级失败。',
  'rokcodeUpdate.toast.reload.message': '正在重启 Rokcode...',
  ...
  'openChamberLogo.aria.logo': 'Rok Desktop 标志',
