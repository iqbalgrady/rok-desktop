...
import { getWorktreeSetupCommands, getWorktreeSetupWaitEnabled } from '@/lib/rokDesktopConfig';
import {
...
const initializeSessionForWorktree = (sessionId: string, metadata: {
  ...
  sessionStore.initializeNewRokDesktopSession(sessionId, configState.agents);
