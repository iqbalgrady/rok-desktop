...
import rok_desktop_dark_raw from './fields-of-the-shire-dark.json';
import rok_desktop_light_raw from './fields-of-the-shire-light.json';
...
export const presetThemes: Theme[] = [
  rok_desktop_dark_raw as Theme,
  rok_desktop_light_raw as Theme,
