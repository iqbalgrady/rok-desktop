...
const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.rok-desktop.visual.field.timeFormat',
    keywords: ['clock', '12h', '24h'],
  },
  {
    id: 'appearance.week-start',
    page: 'appearance',
    titleKey: 'settings.rok-desktop.visual.field.weekStartsOn',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.rok-desktop.visual.field.lightTheme',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.rok-desktop.visual.field.darkTheme',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.rok-desktop.visual.field.macVibrancy',
    descriptionKey: 'settings.rok-desktop.visual.field.macVibrancyHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.rok-desktop.visual.field.dockBadge',
    descriptionKey: 'settings.rok-desktop.visual.field.dockBadgeHint',
    keywords: ['dock', 'badge', 'unread', 'unseen', 'counter', 'count', 'notification', 'macos'],
    // Exactly matches the render guard in RokDesktopVisualSettings: any darwin
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.rok-desktop.visual.field.installAppName',
    descriptionKey: 'settings.rok-desktop.visual.field.installAppNameHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.rok-desktop.visual.field.installOrientation',
    descriptionKey: 'settings.rok-desktop.visual.field.installOrientationHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.rok-desktop.visual.field.mobileKeyboardMode',
    descriptionKey: 'settings.rok-desktop.visual.field.mobileKeyboardModeHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.rok-desktop.visual.field.interfaceFontSize',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.rok-desktop.visual.field.terminalFontSize',
    keywords: ['terminal', 'font', 'text size'],
  },
  {
    id: 'appearance.spacing-density',
    page: 'appearance',
    titleKey: 'settings.rok-desktop.visual.field.spacingDensity',
    keywords: ['density', 'compact', 'comfortable', 'spacing'],
  },
  {
    id: 'appearance.input-bar-offset',
    page: 'appearance',
    titleKey: 'settings.rok-desktop.visual.field.inputBarOffset',
    descriptionKey: 'settings.rok-desktop.visual.field.inputBarOffsetTooltip',
    keywords: ['input', 'home bar', 'offset'],
  },
  {
    id: 'appearance.expanded-editor-toolbar',
    page: 'appearance',
    titleKey: 'settings.rok-desktop.visual.field.expandedEditorToolbar',
    keywords: ['editor', 'toolbar', 'tabs', 'docked', 'files'],
  },
  {
    id: 'appearance.file-editor-keymap',
    page: 'appearance',
    titleKey: 'settings.rok-desktop.visual.field.fileEditorKeymap',
    keywords: ['editor', 'vim', 'keymap'],
  },
  {
    id: 'appearance.terminal-quick-keys',
    page: 'appearance',
    titleKey: 'settings.rok-desktop.visual.field.terminalQuickKeys',
    descriptionKey: 'settings.rok-desktop.visual.field.terminalQuickKeysTooltip',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.rok-desktop.visual.field.sendAnonymousUsageReports',
    descriptionKey: 'settings.rok-desktop.visual.field.sendAnonymousUsageReportsHint',
    keywords: ['telemetry', 'analytics'],
  },
  {
    id: 'chat.render-mode',
    page: 'chat',
    titleKey: 'settings.rok-desktop.visual.section.chatRenderMode',
    keywords: ['messages', 'conversation', 'rendering'],
  },
  {
    id: 'chat.message-transport',
    page: 'chat',
    titleKey: 'settings.rok-desktop.visual.section.messageStreamTransport',
    keywords: ['streaming', 'sse', 'websocket'],
  },
  {
    id: 'chat.reasoning-traces',
    page: 'chat',
    titleKey: 'settings.rok-desktop.visual.field.showReasoningTraces',
    keywords: ['thinking', 'reasoning'],
  },
  {
    id: 'chat.sticky-user-header',
    page: 'chat',
    titleKey: 'settings.rok-desktop.visual.field.stickyUserHeader',
    keywords: ['messages', 'header'],
  },
  {
    id: 'chat.collapsible-user-messages',
    page: 'chat',
    titleKey: 'settings.rok-desktop.visual.field.collapsibleUserMessages',
    keywords: ['collapse', 'expand', 'clamp', 'long messages', 'user messages'],
  },
  {
    id: 'chat.wide-layout',
    page: 'chat',
    titleKey: 'settings.rok-desktop.visual.field.wideChatLayout',
    keywords: ['layout', 'wide', 'messages'],
  },
  {
    id: 'chat.inline-assistant-actions',
    page: 'chat',
    titleKey: 'settings.rok-desktop.visual.field.showSplitAssistantMessageActions',
    descriptionKey: 'settings.rok-desktop.visual.field.showSplitAssistantMessageActionsTooltip',
    keywords: ['copy', 'save image', 'read aloud'],
  },
  {
    id: 'chat.tool-file-icons',
    page: 'chat',
    titleKey: 'settings.rok-desktop.visual.field.showToolFileIcons',
    keywords: ['tools', 'files', 'icons'],
  },
  {
    id: 'chat.changed-files',
    page: 'chat',
    titleKey: 'settings.rok-desktop.visual.field.showTurnChangedFiles',
    keywords: ['changed files', 'turns'],
  },
  {
    id: 'chat.dotfiles',
    page: 'chat',
    titleKey: 'settings.rok-desktop.visual.field.showDotfiles',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.rok-desktop.visual.section.followUpBehavior',
    descriptionKey: 'settings.rok-desktop.visual.field.followUpBehaviorDescription',
    keywords: ['follow up', 'queue', 'steer', 'send immediately'],
  },
  {
    id: 'chat.persist-drafts',
    page: 'chat',
    titleKey: 'settings.rok-desktop.visual.field.persistDraftMessages',
    keywords: ['draft', 'message'],
  },
  {
    id: 'chat.spellcheck',
    page: 'chat',
    titleKey: 'settings.rok-desktop.visual.field.enableSpellcheckInTextInputs',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.rok-desktop.defaults.field.defaultModel',
    keywords: ['model', 'provider', 'new sessions'],
  },
  {
    id: 'sessions.default-thinking',
    page: 'sessions',
    titleKey: 'settings.rok-desktop.defaults.field.defaultThinking',
    keywords: ['thinking', 'reasoning', 'variant'],
  },
  {
    id: 'sessions.default-agent',
    page: 'sessions',
    titleKey: 'settings.rok-desktop.defaults.field.defaultAgent',
    keywords: ['agent', 'new sessions'],
  },
  {
    id: 'sessions.deletion-dialog',
    page: 'sessions',
    titleKey: 'settings.rok-desktop.defaults.field.showDeletionDialog',
    keywords: ['delete', 'confirmation'],
  },
  {
    id: 'sessions.auto-cleanup',
    page: 'sessions',
    titleKey: 'settings.rok-desktop.sessionRetention.field.enableAutoCleanup',
    descriptionKey: 'settings.rok-desktop.sessionRetention.tooltip',
    keywords: ['retention', 'archive', 'delete'],
  },
  {
    id: 'sessions.retention-period',
    page: 'sessions',
    titleKey: 'settings.rok-desktop.sessionRetention.field.retentionPeriod',
    keywords: ['days', 'cleanup', 'retention'],
  },
  {
    id: 'sessions.retention-action',
    page: 'sessions',
    titleKey: 'settings.rok-desktop.sessionRetention.field.whenSessionsExpire',
    keywords: ['archive', 'delete', 'expire'],
  },
  {
    id: 'sessions.desktop-launch-at-login',
    page: 'sessions',
    titleKey: 'settings.rok-desktop.desktopNetwork.field.launchAtLogin',
    descriptionKey: 'settings.rok-desktop.desktopNetwork.field.launchAtLoginDescription',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.rok-desktop.desktopPassword.field.password',
    descriptionKey: 'settings.rok-desktop.desktopPassword.field.passwordDescription',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.rok-desktop.desktopNetwork.field.allowLanAccess',
    descriptionKey: 'settings.rok-desktop.desktopNetwork.field.allowLanAccessDescription',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.rok-desktop.opencodeCli.field.binaryPath',
  ...
  },
  {
    id: 'git.changes-view',
    page: 'git',
    titleKey: 'settings.rok-desktop.git.changesViewTitle',
    keywords: ['changes', 'flat list', 'tree view'],
  },
  {
    id: 'git.gitmoji',
    page: 'git',
    titleKey: 'settings.rok-desktop.git.enableGitmoji',
    keywords: ['commit', 'emoji'],
  },
  {
    id: 'git.gitignored-files',
    page: 'git',
    titleKey: 'settings.rok-desktop.git.showGitignored',
  ...
  },
  {
    ...
    page: 'projects',
    titleKey: 'settings.rok-desktop.worktrees.setup.waitForCommands',
  ...
  },
  {
    ...
    page: 'shortcuts',
    titleKey: 'settings.rok-desktop.keyboardShortcuts.title',
    descriptionKey: 'settings.rok-desktop.keyboardShortcuts.tooltip',
  ...
  },
  {
    id: 'tunnel.provider',
    page: 'tunnel',
    titleKey: 'settings.rok-desktop.tunnel.field.provider',
    descriptionKey: 'settings.rok-desktop.tunnel.description',
  ...
  },
  {
    id: 'tunnel.type',
    page: 'tunnel',
    titleKey: 'settings.rok-desktop.tunnel.field.tunnelType',
  ...
  },
  {
    id: 'tunnel.ttl',
    page: 'tunnel',
    titleKey: 'settings.rok-desktop.tunnel.field.connectLinkTtl',
    descriptionKey: 'settings.rok-desktop.tunnel.field.tunnelSessionTtl',
  ...
  },
  {
    ...
    page: 'tunnel',
    titleKey: 'settings.rok-desktop.tunnel.section.savedManagedRemoteTunnels',
  ...
  },
  {
    ...
    page: 'tunnel',
    titleKey: 'settings.rok-desktop.tunnel.field.configurationFile',
    descriptionKey: 'settings.rok-desktop.tunnel.note.managedLocalUsesConfig',
  ...
  },
  {
    id: 'tunnel.start',
    page: 'tunnel',
    titleKey: 'settings.rok-desktop.tunnel.actions.startTunnel',
    descriptionKey: 'settings.rok-desktop.tunnel.note.connectLinksOneTime',
