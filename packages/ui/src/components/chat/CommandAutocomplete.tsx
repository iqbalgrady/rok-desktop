...
type CommandSource = 'rok-desktop' | 'opencode' | 'skill';
      ...
      try {
        ...
        const builtInCommands: CommandInfo[] = [
          ...(hasSession && !hasMessagesInCurrentSession
            ? [{ id: 'rok-desktop:init', name: 'init', source: 'rok-desktop' as const, description: t('chat.commandAutocomplete.command.initDescription'), isBuiltIn: true }]
            : []
          ),
          ...(hasSession  // Show when session exists, not when hasMessages
            ? [
                { id: 'rok-desktop:undo', name: 'undo', source: 'rok-desktop' as const, description: t('chat.commandAutocomplete.command.undoDescription'), isBuiltIn: true },
                { id: 'rok-desktop:redo', name: 'redo', source: 'rok-desktop' as const, description: t('chat.commandAutocomplete.command.redoDescription'), isBuiltIn: true },
                { id: 'rok-desktop:timeline', name: 'timeline', source: 'rok-desktop' as const, description: t('chat.commandAutocomplete.command.timelineDescription'), isBuiltIn: true },
              ]
            : []
          ),
          { id: 'rok-desktop:compact', name: 'compact', source: 'rok-desktop' as const, description: t('chat.commandAutocomplete.command.compactDescription'), isBuiltIn: true },
          ...(hasSession
            ? [{ id: 'rok-desktop:summary', name: 'summary', source: 'rok-desktop' as const, description: t('chat.commandAutocomplete.command.summaryDescription'), isRokDesktop: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'rok-desktop:workspace-review', name: 'workspace-review', source: 'rok-desktop' as const, description: t('chat.commandAutocomplete.command.workspaceReviewDescription'), isRokDesktop: true }]
            : []
          ),
          ...(canUseReviewHandoffFlow
            ? [{ id: 'rok-desktop:handoff-review', name: 'handoff-review', source: 'rok-desktop' as const, description: t('chat.commandAutocomplete.command.handoffReviewDescription'), isRokDesktop: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'rok-desktop:plan-feature', name: 'plan-feature', source: 'rok-desktop' as const, description: t('chat.commandAutocomplete.command.featurePlanDescription'), isRokDesktop: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'rok-desktop:catch-up', name: 'catch-up', source: 'rok-desktop' as const, description: t('chat.commandAutocomplete.command.catchUpDescription'), isRokDesktop: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'rok-desktop:debug', name: 'debug', source: 'rok-desktop' as const, description: t('chat.commandAutocomplete.command.debugDescription'), isRokDesktop: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'rok-desktop:weigh', name: 'weigh', source: 'rok-desktop' as const, description: t('chat.commandAutocomplete.command.weighDescription'), isRokDesktop: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'rok-desktop:explore', name: 'explore', source: 'rok-desktop' as const, description: t('chat.commandAutocomplete.command.exploreDescription'), isRokDesktop: true }]
            : []
          ),
        ];
        ...
        {loading ? (
          ...
          <div>
            {commands.map((command, index) => {
              ...
              const isRokDesktopBadge = command.isRokDesktop;
              return (
                <div
                  key={command.id}
