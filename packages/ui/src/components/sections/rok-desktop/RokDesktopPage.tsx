...
import { RokDesktopVisualSettings } from './RokDesktopVisualSettings';
...
import type { RokDesktopSection } from './types';
...
interface RokDesktopPageProps {
    /** Which section to display. If undefined, shows all sections (mobile/legacy behavior) */
    section?: RokDesktopSection;
}

export const RokDesktopPage: React.FC<RokDesktopPageProps> = ({ section }) => {
    ...
    if (!section) {
        return (
            <ScrollableOverlay
                ...
                className="w-full"
            >
                <div className="rok-desktop-page-body mx-auto max-w-3xl space-y-3 p-3 sm:space-y-6 sm:p-6 sm:pt-8">
                    <RokDesktopVisualSettings />
    ...
    return (
        <ScrollableOverlay
            ...
            className="w-full"
        >
            <div className="rok-desktop-page-body mx-auto max-w-3xl space-y-6 p-3 sm:p-6 sm:pt-8">
...
const VisualSectionContent: React.FC = () => {
    const isVSCode = isVSCodeRuntime();
    return <RokDesktopVisualSettings visibleSettings={[
        'theme',
        'pwaInstallName',
        'pwaOrientation',
        'mobileKeyboardMode',
