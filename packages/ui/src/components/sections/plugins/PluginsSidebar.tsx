...
export const PluginsSidebar: React.FC<PluginsSidebarProps> = ({
  ...
  React.useEffect(() => {
    ...
    window.addEventListener('rok-desktop:settings-open-plugin-add', handleOpenAdd);
    return () => window.removeEventListener('rok-desktop:settings-open-plugin-add', handleOpenAdd);
  }, []);
