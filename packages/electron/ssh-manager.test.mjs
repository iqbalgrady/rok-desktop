...
describe('ElectronSshManager', () => {
  test('stores a client token for forwarded Rok Desktop hosts when UI password is configured', async () => {
    ...
    const tempDir = fs.mkdtempSync(path.join(os.tmpdir(), 'rok-desktop-ssh-manager-test-'));
