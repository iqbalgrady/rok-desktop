...
struct OverviewWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("RokDesktop")
...
struct QuickActionsWidget: Widget {
    let kind = "RokDesktopQuickActions"
...
struct LockAttentionWidget: Widget {
    let kind = "RokDesktopLockAttention"
...
@main
struct RokDesktopWidgetBundle: WidgetBundle {
