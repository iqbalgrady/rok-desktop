...
```bash
git clone https://github.com/rokcode/rok-desktop.git
cd openchamber
bun install
```
...
| `bun run pack:web` | Create a package archive for `@rok-desktop/server` |
...
Open an [issue](https://github.com/rokcode/rok-desktop/issues) or ask in [Discord](https://discord.gg/ZYRSdnwwKA).
