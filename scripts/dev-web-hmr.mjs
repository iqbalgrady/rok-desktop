...
const uiPort = process.env.ROK_DESKTOP_HMR_UI_PORT || '5180';
const backendPort = process.env.ROK_DESKTOP_HMR_API_PORT || '3902';
const hmrHost = process.env.ROK_DESKTOP_HMR_HOST || '127.0.0.1';
